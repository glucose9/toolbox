...
export const RULES: Rule[] = [
  ...
  { pattern: "오랬동안", fix: "오랫동안", reason: "'오랫동안'이 옳은 표기 (사이시옷 적용).", category: "단어" },
  ...
  { pattern: "비젼", fix: "비전", reason: "외래어 표기법: vision → 비전.", category: "외래어" },
  ...
  { pattern: "악셀", fix: "액셀", reason: "외래어 표기법: accel → 액셀.", category: "외래어" },
