...
export const tools: ToolConfig[] = [
  ...
  },
  {
    ...
    icon: "🧮",
    navTitle: "공학용 계산기",
    title: "공학용 계산기 - 행렬·통계·방정식·삼각함수 (TI-84급)",
    h1: "공학용 계산기",
    description:
      "TI-84+ CE급 공학용 계산기. 식 입력 방식 과학계산(삼각·로그·지수·분수·Ans·변수저장), 다항식·방정식 솔버, 행렬 연산(행렬식·역행렬·rref·연립방정식), 통계(평균·표준편차·사분위·선형회귀)까지 한 곳에서. 모두 브라우저에서 즉시 계산.",
    metaDescription:
      "공학용 계산기 무료 - 삼각함수·로그·분수, 방정식 솔버, 행렬(역행렬·행렬식·rref), 통계·회귀. TI-84급, 식 입력 방식.",
    howTo: [
