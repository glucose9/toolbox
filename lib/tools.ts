...
export type ToolConfig = {
  ...
  component:
    ...
    | "PdfEsignTool"
    | "PdfCompressTool";
  category: "qr" | "barcode" | "image" | "video" | "text" | "dev" | "document" | "pdf" | "calc" | "academic";
  icon: string;
  navTitle: string;
  title: string;
  h1: string;
...
export const tools: ToolConfig[] = [
  ...
  // ===== AI / Image (heavy, lazy) =====
  {
    ...
    icon: "🪄",
    navTitle: "배경 제거",
    title: "이미지 배경 제거 - 인물/사물 누끼 무료 (브라우저 처리)",
    h1: "이미지 배경 제거",
    description:
      "사진에서 인물·사물의 배경을 자동으로 제거해 투명 PNG로 만듭니다. AI 모델이 브라우저 안에서 실행되어 사진은 어디로도 업로드되지 않습니다. 프로필 사진 누끼, 상품 사진 배경 제거, 증명사진, 스티커 제작, 합성용 소스에 유용합니다.",
    metaDescription:
      "이미지 배경 제거 무료. 인물·사물 누끼, 투명 PNG, 브라우저 안에서 AI 처리(업로드 없음).",
    howTo: [
      "이미지를 업로드하거나 드래그합니다.",
      "처음 한 번 AI 모델이 다운로드됩니다 (이후 캐시).",
      "배경이 자동 제거되면 투명 PNG로 다운로드합니다.",
    ],
    faq: [
      { q: "사진이 외부로 전송되나요?", a: "아니요. 배경 제거 모델이 브라우저 안에서 실행됩니다(WASM/ONNX). 사진은 어디로도 업로드되지 않아 안전합니다." },
      { q: "사이트가 무거워지나요?", a: "아니요. AI 모델은 이 도구를 실제로 사용할 때만 다운로드되며, 다른 페이지에는 전혀 영향이 없습니다. 첫 사용 후에는 캐시되어 빠릅니다." },
      { q: "처음에 왜 느린가요?", a: "최초 1회 모델(수 MB)을 받기 때문입니다. 두 번째부터는 캐시되어 즉시 처리됩니다." },
      { q: "어떤 사진이 잘 되나요?", a: "인물, 상품, 동물 등 피사체와 배경 구분이 뚜렷한 사진이 가장 깔끔합니다. 머리카락 같은 세밀한 경계도 비교적 잘 처리됩니다." },
      { q: "결과 배경이 투명한가요?", a: "네. 투명 배경 PNG로 저장됩니다. 합성·스티커·디자인에 바로 사용 가능합니다." },
      { q: "remove.bg와 차이?", a: "remove.bg는 서버에서 처리(업로드 필요, 무료 제한). 본 도구는 브라우저에서 처리해 무료·무제한·비공개입니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    icon: "📐",
    navTitle: "화면비 계산기",
    title: "화면비/종횡비 계산기 - 16:9, 4:3 비율 맞춰 크기 계산",
    h1: "화면비(종횡비) 계산기",
    description:
      "종횡비(예: 16:9)를 유지하면서 너비나 높이 한쪽만 입력하면 나머지를 자동 계산합니다. 동영상 해상도 맞추기, 썸네일·배너 크기, 이미지 리사이즈, 모니터·디자인 작업에 유용. 두 크기에서 비율을 역산하는 기능도 지원합니다.",
    metaDescription:
      "화면비 계산기 무료. 16:9·4:3 비율 유지 크기 계산, 비율 역산. 영상·디자인용.",
    howTo: [
      "비율(예: 16:9)을 선택하거나 직접 입력합니다.",
      "너비 또는 높이 한쪽을 입력합니다.",
      "나머지 치수가 비율에 맞게 자동 계산됩니다.",
    ],
    faq: [
      { q: "비율을 모를 때 역산할 수 있나요?", a: "네. 현재 너비·높이를 입력하면 최대공약수로 약분된 비율(예: 1920×1080 → 16:9)을 알려줍니다." },
      { q: "어떤 비율이 자주 쓰이나요?", a: "16:9(유튜브·모니터), 9:16(쇼츠·릴스), 4:3(구형), 1:1(인스타), 3:2(사진), 21:9(울트라와이드)." },
      { q: "소수점 결과는 어떻게?", a: "픽셀은 정수로 반올림해서 표시합니다. 정확한 비율이 안 떨어지면 가장 가까운 정수로 안내합니다." },
      { q: "동영상 해상도 맞추는 데 쓸 수 있나요?", a: "네. 16:9로 폭 1280을 넣으면 높이 720이 자동 계산됩니다. 인코딩·크롭 전 치수 확인에 유용합니다." },
      { q: "여러 비율을 한 번에 비교?", a: "대표 비율 프리셋 버튼으로 빠르게 전환하며 비교할 수 있습니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    icon: "👁️",
    navTitle: "색약 시뮬레이터",
    title: "색맹/색약 시뮬레이터 - 이미지가 색각이상자에게 어떻게 보이는지",
    h1: "색맹·색약 시뮬레이터",
    description:
      "이미지나 색상이 적색맹(Protanopia)·녹색맹(Deuteranopia)·청색맹(Tritanopia)·전색맹(Achromatopsia) 등 색각이상자에게 어떻게 보이는지 시뮬레이션합니다. 웹·앱 디자인 접근성 점검, 색상 대비 확인, 인포그래픽·차트 색 선택에 유용합니다. 브라우저에서 처리.",
    metaDescription:
      "색맹/색약 시뮬레이터 무료. 적·녹·청색맹 이미지 미리보기, 디자인 접근성 점검.",
    howTo: [
      "이미지를 업로드합니다.",
      "색각이상 유형(적색맹·녹색맹·청색맹 등)을 선택합니다.",
      "원본과 시뮬레이션 결과를 나란히 비교합니다.",
    ],
    faq: [
      { q: "어떤 유형을 지원하나요?", a: "적색맹(Protanopia), 녹색맹(Deuteranopia), 청색맹(Tritanopia), 적색약·녹색약(Anomaly), 전색맹(Achromatopsia)을 지원합니다." },
      { q: "왜 색약 점검이 필요한가요?", a: "남성의 약 8%, 여성의 0.5%가 색각이상입니다. 빨강·초록만으로 정보를 구분하는 디자인은 이들에게 안 보일 수 있어, 접근성(WCAG) 점검에 중요합니다." },
      { q: "정확한가요?", a: "널리 쓰이는 색각 변환 행렬(Brettel/Viénot 기반)을 사용합니다. 실제 색각이상자의 인지와 완전히 같진 않지만 디자인 점검용으로 충분히 유효합니다." },
      { q: "사진이 외부로 가나요?", a: "아니요. 모든 변환은 브라우저 캔버스에서 처리되어 업로드되지 않습니다." },
      { q: "색상 하나만 테스트할 수 있나요?", a: "이미지뿐 아니라 단색 견본도 만들어 테스트할 수 있습니다. 디자인 팔레트 점검에 활용하세요." },
      { q: "어떻게 개선하나요?", a: "색만으로 구분하지 말고 명도 차이·패턴·라벨을 함께 쓰세요. 빨강↔초록 조합을 피하고 파랑↔주황 같은 안전한 조합을 권장합니다." },
    ],
    addedAt: "2026-05-21",
  },
  ...
  // ===== Barcode =====
  {
    ...
    icon: "▮▮",
    navTitle: "바코드 생성기 (통합)",
    title: "바코드 생성기 - EAN-13, Code 128, Code 39, ITF-14, UPC 무료",
    h1: "통합 바코드 생성기",
    description:
      "Code 128·EAN-13·EAN-8·UPC-A·Code 39·ITF-14·Codabar 등 주요 1D 바코드를 모두 한 곳에서 생성합니다. PNG/SVG로 다운로드, 색상 커스터마이즈, 텍스트 표시 옵션. 매장 가격표, 도서관 자료, 자산 라벨, 물류 송장, 의약품 관리, 학생증 등 어디든 사용 가능합니다.",
    metaDescription:
      "1D 바코드 무료 생성기. Code 128, EAN-13, UPC, Code 39, ITF-14. PNG/SVG, 색상 변경.",
    howTo: [
      "위 탭에서 원하는 바코드 형식을 선택합니다.",
      "값을 입력하면 오른쪽에 바코드가 실시간으로 만들어집니다.",
      "필요하면 색상, 텍스트 표시 여부를 조정합니다.",
      "PNG 또는 SVG로 다운로드합니다.",
    ],
    faq: [
      { q: "어떤 형식을 골라야 하나요?", a: "범용·텍스트 포함이면 Code 128, 한국 상품이면 EAN-13, 책은 ISBN(EAN-13의 978 접두), 짧은 작은 제품은 EAN-8, 미국 제품은 UPC-A, 산업·자산은 Code 39, 외부 박스는 ITF-14를 씁니다." },
      { q: "Code 128과 Code 39 차이는?", a: "Code 128은 더 조밀하고 대소문자·기호 모두 가능합니다. Code 39는 옛 표준이라 호환성이 넓지만 길이가 길어집니다. 새 시스템이면 Code 128을 권장합니다." },
      { q: "체크섬은 자동 계산되나요?", a: "네. EAN-13/EAN-8/UPC-A는 마지막 체크 디지트를 자동 계산합니다. 12자리(EAN-13), 7자리(EAN-8), 11자리(UPC-A)만 입력하세요." },
      { q: "스캐너로 읽으려면 최소 크기는?", a: "Code 128 기준 가로 약 2cm 이상, EAN-13은 약 3cm 이상이 안정적입니다. 인쇄 화질에 따라 더 커야 할 수 있습니다." },
      { q: "한글이나 특수문자도 들어가나요?", a: "1D 바코드 표준은 ASCII만 지원합니다. 한글이 필요하면 QR코드를 추천합니다." },
      { q: "PNG vs SVG 어느 게 좋아요?", a: "인쇄용은 SVG (벡터라 크기 무한 확대 가능). 디지털 표시용은 PNG가 일반적입니다." },
      { q: "왜 GS1-128 같은 특수 표준은 없나요?", a: "본 도구는 표준 Code 128을 생성합니다. GS1-128(AI 식별자 포함)은 별도 표준이 있어 전용 도구가 필요합니다." },
    ],
    config: { defaultFormat: "CODE128" },
    addedAt: "2026-05-21",
  },
  {
    slug: "barcode-reader",
    component: "BarcodeReaderTool",
    category: "barcode",
    icon: "🔎",
    navTitle: "바코드 인식기",
    title: "바코드 디코더 - 이미지에서 바코드 자동 인식 (무료)",
    h1: "바코드 이미지 디코더",
    description:
      "EAN-13, Code 128, Code 39, UPC, ITF, QR, DataMatrix, PDF417 등 거의 모든 바코드 형식을 이미지에서 자동으로 읽어냅니다. 카메라 없이 PC에서 바로 디코딩, 사진은 외부로 전송되지 않고 브라우저 안에서 처리. 상품 사진의 바코드 확인, 인쇄 라벨 점검, 도서관 책 ISBN 추출, 영수증 바코드 분석에 유용합니다.",
    metaDescription:
      "바코드 이미지 무료 디코더. EAN, Code 128, UPC, QR, DataMatrix 자동 인식. 브라우저 처리.",
    howTo: [
      "바코드가 있는 이미지를 업로드하거나 드래그합니다.",
      "포맷이 자동 감지되고 내용이 표시됩니다.",
      "복사 버튼으로 결과를 클립보드로 가져옵니다.",
    ],
    faq: [
      { q: "어떤 형식을 인식하나요?", a: "1D: EAN-13, EAN-8, UPC-A, UPC-E, Code 128, Code 39, Code 93, Codabar, ITF. 2D: QR, DataMatrix, PDF417, Aztec, MaxiCode. ZXing 라이브러리 기반." },
      { q: "이미지가 외부로 전송되나요?", a: "아니요. @zxing/library가 브라우저 안에서 디코딩합니다. 사진은 어디로도 업로드되지 않습니다." },
      { q: "흐릿한 사진도 인식되나요?", a: "선명도가 부족하면 인식이 어렵습니다. 가능하면 정면에서 평평하게 찍고, 조명을 충분히 확보하세요. 작아도 글자가 또렷이 보이면 가능합니다." },
      { q: "여러 바코드가 한 사진에 있으면?", a: "현재는 가장 명확한 첫 번째 바코드만 표시됩니다. 영수증처럼 여러 개면 잘라서 한 장씩 업로드하세요." },
      { q: "한글이나 일본어가 결과로 나올 수 있나요?", a: "1D 바코드는 ASCII만 표시됩니다. QR은 한글·일본어 등 모든 유니코드가 가능합니다." },
      { q: "회전된 사진도 인식되나요?", a: "ZXing은 회전·왜곡에 강건한 편이지만 90도 이상 기울어지면 인식이 어려울 수 있습니다. 가능하면 똑바로 찍어주세요." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    icon: "📦",
    navTitle: "EAN-13 바코드",
    title: "EAN-13 바코드 생성기 - 한국 상품 바코드 (880 prefix)",
    h1: "EAN-13 바코드 생성기",
    description:
      "한국 상품 표준 바코드 EAN-13을 무료로 생성합니다. 한국 GS1 접두 코드는 880입니다. 매장 가격표, 자체 제작 상품 라벨, 소상공인 POS 시스템, 마트 출고 라벨에 사용. 체크 디지트는 자동 계산. 12자리 입력하면 마지막 디지트가 자동 추가됩니다.",
    metaDescription:
      "EAN-13 바코드 생성기 무료. 한국 상품(880 prefix), 12자리 → 13자리 자동, PNG/SVG.",
    howTo: [
      "12자리 숫자를 입력합니다 (한국 상품은 880으로 시작).",
      "13번째 체크 디지트는 자동으로 계산됩니다.",
      "PNG 또는 SVG로 다운로드합니다.",
    ],
    faq: [
      { q: "EAN-13 vs UPC-A 차이?", a: "EAN-13은 13자리 (국가 + 회사 + 상품 + 체크), UPC-A는 12자리(미국 표준). 한국·유럽·일본은 EAN-13, 미국은 UPC-A를 씁니다." },
      { q: "한국 회사 코드 880은 누구한테 받나요?", a: "GS1 Korea(한국유통물류진흥원)에서 회사 코드를 부여받습니다. 정식 상품은 GS1 등록 필수, 사내·내부 관리용은 임의 번호 가능합니다." },
      { q: "체크 디지트는 왜 필요한가요?", a: "스캔 오류 검출용입니다. 마지막 1자리는 앞 12자리에서 계산되며, 잘못 스캔하면 일치 안 함을 감지합니다. 본 도구가 자동 계산합니다." },
      { q: "도서 ISBN과는 다른가요?", a: "ISBN은 978·979로 시작하는 EAN-13입니다. 별도 [ISBN 바코드] 도구에서는 ISBN-10도 자동 변환합니다." },
      { q: "880으로 시작 안 해도 되나요?", a: "한국 외 국가 코드면 다른 prefix를 씁니다. 일본 45·49, 미국 0·1, 영국 50, 독일 40~44 등. 880은 한국용입니다." },
      { q: "13자리 그대로 입력하면 안 되나요?", a: "13자리 입력 시 마지막 자리를 검증합니다. 12자리만 입력하면 자동 계산되어 편합니다." },
    ],
    config: { defaultFormat: "EAN13" },
    addedAt: "2026-05-21",
  },
  {
    slug: "barcode-ean8",
    ...
    icon: "📦",
    navTitle: "EAN-8 바코드",
    title: "EAN-8 바코드 생성기 - 작은 상품용 짧은 바코드",
    h1: "EAN-8 바코드 생성기",
    description:
      "작은 상품(립밤·껌·소형 부속품)에 쓰이는 짧은 EAN-8 바코드를 생성합니다. 7자리 입력하면 체크 디지트가 자동 계산됩니다. 큰 EAN-13 라벨이 들어가지 않는 작은 패키지나 좁은 인쇄 영역에 적합합니다.",
    metaDescription:
      "EAN-8 바코드 무료 생성. 작은 상품용 8자리 바코드, 체크 디지트 자동.",
    howTo: ["7자리 숫자를 입력합니다.", "체크 디지트가 자동으로 계산됩니다.", "PNG·SVG 다운로드."],
    faq: [
      { q: "EAN-8은 언제 쓰나요?", a: "EAN-13 라벨이 들어가지 않을 만큼 작은 상품에 씁니다. 사탕·립밤·작은 부속 등." },
      { q: "EAN-13처럼 회사 코드 받아야 하나요?", a: "정식 상품 유통이면 GS1 Korea 등록이 필요합니다. 내부 관리용은 임의 번호 OK." },
      { q: "EAN-13보다 좋은 점은?", a: "더 짧아 작은 라벨에 들어갑니다. 다만 정보량(상품 식별 코드 수)이 적습니다." },
      { q: "체크 디지트 계산 공식은?", a: "(홀수 자리 × 3 + 짝수 자리)의 합을 10으로 나눈 나머지를 10에서 뺀 값. 본 도구가 자동 처리합니다." },
      { q: "8자리 그대로 넣어도 되나요?", a: "8자리면 마지막 체크 자리를 검증합니다. 7자리만 입력하는 게 편합니다." },
    ],
    config: { defaultFormat: "EAN8" },
    addedAt: "2026-05-21",
  },
  {
    slug: "barcode-upc",
    ...
    icon: "🇺🇸",
    navTitle: "UPC-A 바코드",
    title: "UPC-A 바코드 생성기 - 미국 표준 12자리 바코드",
    h1: "UPC-A 바코드 생성기",
    description:
      "미국·캐나다 표준 상품 바코드 UPC-A를 생성합니다. 12자리 (제조사 + 상품 + 체크). 미국 마트, 아마존 FBA, 미국향 수출 상품에 필수입니다. 한국 제품을 미국에 판매할 때 EAN-13 대신 UPC-A를 요구하는 경우가 많습니다.",
    metaDescription:
      "UPC-A 바코드 생성기 무료. 미국 표준 12자리, 아마존·미국 마트용. 체크 디지트 자동.",
    howTo: ["11자리 숫자를 입력합니다.", "12번째 체크 디지트가 자동 계산됩니다.", "PNG·SVG로 다운로드해 라벨에 사용합니다."],
    faq: [
      { q: "UPC-A vs EAN-13?", a: "UPC-A는 12자리 (미국), EAN-13은 13자리(나머지 나라). EAN-13 앞에 0을 붙이면 UPC-A 호환이지만 미국 GS1 정식 코드를 받는 게 안전합니다." },
      { q: "아마존 FBA에 쓸 수 있나요?", a: "네. UPC-A는 아마존 FBA 등록 시 기본 사용 형식입니다. GS1 US에서 회사 코드를 받아야 정식 등록 가능합니다." },
      { q: "회사 코드 어디서 받나요?", a: "GS1 US (www.gs1us.org). 연회비가 있습니다. 한국 GS1과는 별도 등록입니다." },
      { q: "UPC-E도 만들 수 있나요?", a: "UPC-E는 UPC-A의 압축형(6자리)으로 작은 상품용입니다. 본 도구는 UPC-A만 지원합니다." },
      { q: "12자리 그대로 입력해도 되나요?", a: "12자리면 마지막 체크 자리를 검증, 11자리만 입력하면 자동 계산됩니다." },
    ],
    config: { defaultFormat: "UPC" },
    addedAt: "2026-05-21",
  },
  {
    slug: "barcode-isbn",
    ...
    icon: "📚",
    navTitle: "ISBN 바코드",
    title: "ISBN 바코드 생성기 - 도서 EAN-13 자동 변환",
    h1: "ISBN 바코드 생성기 (책)",
    description:
      "ISBN-10 또는 ISBN-13을 입력하면 EAN-13 바코드로 자동 변환합니다. ISBN-10은 978 접두사를 붙여 ISBN-13으로 자동 변환. 책 표지·뒷면 인쇄용, 도서관 자료 관리, 출판물 등록, 독립 출판 작가의 ISBN 등록 후 표지 디자인에 사용합니다.",
    metaDescription:
      "ISBN 바코드 무료 생성. ISBN-10 → ISBN-13 자동 변환, 도서 표지·도서관용 EAN-13.",
    howTo: [
      "ISBN-10 또는 ISBN-13을 입력합니다 (하이픈 있어도 됨).",
      "ISBN-10이면 자동으로 978 접두 ISBN-13으로 변환됩니다.",
      "PNG/SVG로 다운로드해 책 표지에 사용합니다.",
    ],
    faq: [
      { q: "ISBN-10과 ISBN-13의 차이?", a: "ISBN-10은 옛 표준(10자리), ISBN-13은 현 표준(13자리). 2007년부터 ISBN-13만 발급됩니다. ISBN-10은 앞에 978을 붙이고 체크 디지트를 재계산하면 ISBN-13이 됩니다." },
      { q: "한국 도서는 어떤 prefix?", a: "ISBN-13의 978-89-... 가 한국 도서, 979-11-... 도 추가 할당된 한국 코드입니다." },
      { q: "ISBN은 어디서 받나요?", a: "국립중앙도서관 ISBN/ISSN 신청 시스템에서 무료로 신청할 수 있습니다. 개인 출판도 가능합니다." },
      { q: "EAN-13과 호환되나요?", a: "ISBN-13은 EAN-13의 한 종류입니다(978·979로 시작). 일반 EAN-13 스캐너로 모두 읽힙니다." },
      { q: "ISBN에 가격 정보도 들어가나요?", a: "ISBN 자체에는 가격이 없습니다. 책 뒤표지에는 ISBN과 별도로 가격 바코드(EAN-5)를 추가 인쇄하기도 합니다." },
      { q: "ISBN 없이 임의로 만들면 어떻게 되나요?", a: "정식 ISBN이 아니면 ISBN으로 인정받지 못합니다. 학교 과제·내부 자료용은 무관하지만, 서점·도서관 유통은 정식 ISBN 필수." },
    ],
    config: { defaultFormat: "EAN13", isbn: true },
    addedAt: "2026-05-21",
  },
  {
    ...
    category: "barcode",
    icon: "▮▮",
    navTitle: "Code 128 바코드",
    title: "Code 128 바코드 생성기 - 영문/숫자/기호 가능 고밀도 바코드",
    h1: "Code 128 바코드 생성기",
    description:
      "물류·운송·자산 관리에서 가장 많이 쓰는 Code 128 바코드를 생성합니다. ASCII 모든 문자(영문 대소문자·숫자·기호) 지원, 같은 길이에 더 많은 정보를 담을 수 있어 효율적. 송장 번호, 트래킹 ID, 자산 태그, 학생증, 시리얼 번호에 적합합니다.",
    metaDescription:
      "Code 128 바코드 생성 무료. 영문·숫자·기호 가능, 송장·자산·물류용 고밀도 바코드.",
    howTo: [
      "바코드로 만들 텍스트를 입력합니다 (영문·숫자·기호 가능).",
      "체크섬은 자동으로 계산됩니다.",
      "PNG·SVG로 다운로드합니다.",
    ],
    faq: [
      { q: "Code 128이 왜 인기 있나요?", a: "ASCII 전체 지원 + 고밀도 (Code 39 대비 30% 짧음). 물류·송장 추적·자산 관리의 사실상 표준입니다." },
      { q: "최대 글자 수는?", a: "이론상 제한 없지만 실용적으로는 약 20~25자가 안정적입니다. 더 길면 바코드가 너무 길어져 스캔하기 어렵습니다." },
      { q: "한글도 가능한가요?", a: "Code 128은 ASCII만 지원합니다. 한글이 필요하면 QR코드를 추천합니다." },
      { q: "Code 128 A/B/C 자동 전환은?", a: "본 도구는 jsBarcode의 자동 모드를 씁니다. 짧은 숫자만 있으면 C(2자리 압축), 영문 섞이면 A/B로 자동 전환." },
      { q: "GS1-128과는 다른가요?", a: "GS1-128(이전 EAN-128)은 Code 128에 GS1 AI(Application Identifier) 규칙을 더한 표준입니다. 본 도구는 일반 Code 128입니다." },
      { q: "체크섬 계산은요?", a: "Code 128은 modulo 103 체크섬이 필수이며 jsBarcode가 자동 추가합니다. 별도로 입력할 필요 없습니다." },
    ],
    config: { defaultFormat: "CODE128" },
    addedAt: "2026-05-21",
  },
  {
    ...
    category: "barcode",
    icon: "🏷️",
    navTitle: "Code 39 바코드",
    title: "Code 39 바코드 생성기 - 호환성 넓은 1D 바코드",
    h1: "Code 39 바코드 생성기",
    description:
      "1974년부터 쓰인 Code 39는 거의 모든 바코드 스캐너가 지원하는 호환성 1위 바코드입니다. 영문 대문자·숫자·일부 기호(-, ., 공백, $, /, +, %)를 지원하며, 옛 산업·정부·학교 시스템·도서관 자료에서 여전히 많이 쓰입니다. 자산 관리 라벨, 학교 학생증, 정부 문서 분류에 적합.",
    metaDescription:
      "Code 39 바코드 무료 생성. 호환성 1위, 영문 대문자·숫자, 자산·학생증·정부 문서용.",
    howTo: [
      "영문 대문자, 숫자, 일부 기호를 입력합니다.",
      "바코드가 즉시 만들어집니다.",
      "PNG·SVG로 다운로드합니다.",
    ],
    faq: [
      { q: "Code 39 vs Code 128 차이?", a: "Code 39는 더 오래되고 호환성이 좋지만 같은 정보를 표현할 때 약 30% 더 깁니다. 옛 시스템과 호환이 필요하면 Code 39, 새 시스템은 Code 128을 권장합니다." },
      { q: "왜 영문 소문자가 안 되나요?", a: "Code 39 표준이 대문자만 지원합니다. 소문자가 필요하면 Code 128 또는 Code 39 확장(Code 39 Extended)을 사용해야 합니다." },
      { q: "어떤 기호가 가능한가요?", a: "- (하이픈), . (점), 공백, $, /, +, %. 그 외 기호는 지원하지 않습니다." },
      { q: "체크 디지트가 필요한가요?", a: "Code 39는 체크 디지트 옵션입니다. 본 도구는 기본적으로 추가하지 않습니다. 필요하면 Mod 43 체크 디지트를 직접 계산해 포함하세요." },
      { q: "어디에 많이 쓰이나요?", a: "미국 국방부 LOGMARS, 도서관 자료 분류, 학교 자산 라벨, 의료 환자 ID 등 옛 시스템과 정부·학교에서 흔합니다." },
      { q: "스캐너 호환성은?", a: "모든 1D 바코드 스캐너가 Code 39를 지원합니다. 호환성이 가장 중요한 환경에 적합합니다." },
    ],
    config: { defaultFormat: "CODE39" },
    addedAt: "2026-05-21",
  },
  {
    slug: "barcode-itf14",
    ...
    icon: "📦",
    navTitle: "ITF-14 바코드",
    title: "ITF-14 바코드 생성기 - 외부 박스·상자 단위 바코드",
    h1: "ITF-14 바코드 생성기",
    description:
      "상자·박스 단위 묶음 표시용 ITF-14 바코드를 생성합니다. 13자리 입력 → 체크 디지트 자동. ITF-14는 두꺼운 검은 바와 큰 인쇄 크기로 잘 안 보이는 거리에서도 스캔 가능해, 물류 창고·트럭 적재·외부 카톤(outer carton) 라벨에 표준으로 쓰입니다.",
    metaDescription:
      "ITF-14 바코드 무료 생성. 박스·카톤 단위, 13자리, 물류·창고 적재용.",
    howTo: [
      "13자리 숫자를 입력합니다.",
      "14번째 체크 디지트가 자동 계산됩니다.",
      "PNG·SVG로 다운로드해 박스 라벨에 인쇄합니다.",
    ],
    faq: [
      { q: "ITF-14는 EAN-13과 뭐가 다르죠?", a: "ITF-14는 14자리, EAN-13은 13자리. ITF-14는 상자(carton) 단위, EAN-13은 개별 상품 단위. ITF-14의 첫 자리는 indicator로 묶음 단위를 나타냅니다." },
      { q: "indicator는 뭐예요?", a: "ITF-14의 첫 자리(0~8). 0은 변동 단위, 1~8은 묶음 단위 (예: 12개입은 1). 회사가 자체 규칙으로 정합니다." },
      { q: "어디에 인쇄하나요?", a: "외부 카톤(상자) 양옆에 인쇄. 크기는 가로 3~12cm가 표준이며, 큰 박스에는 큰 바코드를 사용합니다." },
      { q: "왜 막대가 두꺼운가요?", a: "물류 환경(어두운 창고, 흔들리는 트럭)에서 멀리서 스캔하기 위해 의도적으로 두껍게 인쇄합니다." },
      { q: "Bearer Bar가 필요한가요?", a: "ITF-14 표준은 바코드 둘레에 검은 테두리(Bearer Bar)를 권장합니다. 본 도구는 기본 ITF-14를 생성하니, 인쇄 시 테두리는 별도 추가하세요." },
      { q: "GTIN과의 관계?", a: "ITF-14는 GTIN-14(글로벌 거래 품목 번호)의 시각적 인코딩입니다. 묶음 상품의 GTIN을 받았다면 그대로 입력하세요." },
    ],
    config: { defaultFormat: "ITF14" },
    addedAt: "2026-05-21",
  },
  ...
  {
    slug: "hwp-editor",
    component: "HwpEditorTool",
    category: "document",
    icon: "✏️",
    navTitle: "HWPX 에디터",
    title: "HWPX 에디터 - 본문 · 글꼴 · 크기 설정 후 HWPX 생성 (한컴 불필요)",
    h1: "HWPX 에디터 (본문 · 글꼴 · 크기)",
    description:
      "한컴오피스 없이 브라우저에서 본문을 작성하고 글꼴·크기를 선택해 HWPX(KS X 6101) 파일로 저장합니다. 간단한 안내문·공지·서식 작성, 한컴 라이선스가 없는 PC에서 한글 파일 만들기, 공공기관 제출용 표준 HWPX 빠른 생성에 자주 쓰입니다.",
    metaDescription:
      "HWPX 에디터 무료. 본문·글꼴·크기 선택 후 .hwpx 저장, 한컴오피스 불필요.",
    howTo: [
      "본문을 입력합니다.",
      "글꼴(함초롬바탕·맑은 고딕·나눔고딕 등)과 글자 크기(pt)를 선택합니다.",
      "파일명을 정하고 [.hwpx 다운로드] 버튼을 누릅니다.",
      "다운로드된 .hwpx 파일을 한컴오피스 2018+ 또는 호환 뷰어에서 엽니다.",
    ],
    faq: [
      { q: "한컴오피스 어떤 버전부터 열 수 있나요?", a: "한컴오피스 2018(NEO+) 이상에서 HWPX를 기본 지원합니다. 2014 이하 구버전은 별도 변환이 필요합니다." },
      { q: "왜 .hwp가 아니라 .hwpx인가요?", a: ".hwp는 한컴 전용 바이너리라 외부에서 생성이 어렵지만, .hwpx는 정부 표준(KS X 6101)으로 공개된 XML+ZIP 형식이라 안전하게 만들 수 있습니다. 한컴오피스가 .hwpx도 100% 지원합니다." },
      { q: "표·이미지·서식도 넣을 수 있나요?", a: "이 도구는 미니멀 생성기로 본문 텍스트 + 글꼴 + 크기만 지원합니다. 표·이미지·복잡한 서식이 필요하면 생성된 HWPX를 한컴오피스에서 열어 직접 편집하세요." },
      { q: "글꼴 이름을 자유롭게 입력해도 되나요?", a: "네. 프리셋 외에 직접 입력도 가능합니다. 다만 실제 PC에 그 글꼴이 설치되어 있어야 한컴오피스가 정확히 표시하고, 없으면 비슷한 글꼴로 대체합니다." },
      { q: "여러 단락은 어떻게 만드나요?", a: "본문에서 Enter로 줄바꿈하면 각 줄이 별도의 단락으로 저장됩니다." },
      { q: "파일이 외부로 전송되나요?", a: "아니요. HWPX는 브라우저 안에서 JSZip으로 직접 패키징되어 어디로도 전송되지 않습니다. 인사·법무·계약 같은 민감한 문서도 안심하고 만들 수 있습니다." },
      { q: "더 풍부한 편집이 필요한데?", a: "텍스트 + 서식이 풍부한 마크다운 형태가 필요하면 [마크다운 + 수식] 도구로 작성 후 PDF로 출력하거나, 워드 파일로 만든 뒤 한컴에서 변환할 수도 있습니다." },
    ],
    addedAt: "2026-05-18",
  },

  // ===== PowerPoint (PPTX) =====
  { slug: "pptx-viewer", component: "PptxViewerTool", category: "document", icon: "📊", navTitle: "PPTX 뷰어", title: "PPTX 뷰어 - 파워포인트 없이 브라우저에서 PPT 열기", h1: "PPTX 뷰어 (파워포인트 미리보기)", description: "파워포인트(.pptx) 파일을 파워포인트 설치 없이 브라우저에서 바로 열어 슬라이드를 미리봅니다. 파일은 서버로 업로드되지 않고 기기 안에서만 처리됩니다. 받은 발표 자료 빠르게 확인, PPT 없는 PC·태블릿에서 열람, 첨부파일 미리보기에 유용합니다.", metaDescription: "PPTX 뷰어 무료. 파워포인트 없이 브라우저에서 .pptx 슬라이드 미리보기, 업로드 없음.", howTo: ["PPTX 파일을 드래그하거나 선택합니다.", "슬라이드가 순서대로 렌더링됩니다.", "스크롤하며 내용을 확인합니다."], faq: [{ q: "파일이 외부로 전송되나요?", a: "아니요. 브라우저 안에서만 파싱·렌더링되며 어디로도 업로드되지 않습니다. 민감한 발표 자료도 안전합니다." }, { q: "원본과 100% 똑같이 보이나요?", a: "빠른 미리보기용입니다. 텍스트·이미지·기본 레이아웃은 잘 표시되지만, 복잡한 애니메이션·SmartArt·일부 폰트는 원본과 다를 수 있습니다. 정밀 편집은 파워포인트를 사용하세요." }, { q: ".ppt(구버전)도 되나요?", a: "최신 .pptx(2007+) 형식을 지원합니다. 구형 .ppt는 파워포인트에서 .pptx로 저장 후 열어주세요." }, { q: "슬라이드 텍스트만 빼내고 싶어요.", a: "[PPTX 텍스트 추출] 도구를 사용하면 모든 슬라이드의 글자를 한 번에 복사할 수 있습니다." }, { q: "슬라이드 안 이미지를 저장하려면?", a: "[PPTX 이미지 추출] 도구로 발표 자료에 들어간 모든 이미지를 한 번에 받을 수 있습니다." }], addedAt: "2026-05-26" },
  { slug: "pptx-to-text", component: "PptxToTextTool", category: "document", icon: "📝", navTitle: "PPTX 텍스트 추출", title: "PPTX 텍스트 추출 - 파워포인트 모든 슬라이드 글자 복사", h1: "PPTX 텍스트 추출기", description: "파워포인트(.pptx) 파일에서 모든 슬라이드의 텍스트를 한 번에 추출합니다. 슬라이드별로 구분해 표시하고 복사·다운로드할 수 있습니다. 발표 대본 정리, 내용 검색·번역, 문서화, 표절 검사 전처리에 유용합니다. 브라우저에서 처리.", metaDescription: "PPTX 텍스트 추출 무료. 파워포인트 모든 슬라이드 글자 복사·다운로드, 업로드 없음.", howTo: ["PPTX 파일을 업로드합니다.", "모든 슬라이드의 텍스트가 슬라이드 순서대로 추출됩니다.", "전체 복사하거나 .txt로 다운로드합니다."], faq: [{ q: "슬라이드 순서대로 나오나요?", a: "네. 슬라이드 1, 2, 3... 순서로 구분해 표시합니다." }, { q: "발표자 노트도 추출되나요?", a: "슬라이드 본문 텍스트를 추출합니다. 발표자 노트 포함 옵션도 지원합니다." }, { q: "표 안의 글자도 나오나요?", a: "네. 텍스트 상자, 표, 도형 안의 글자를 모두 추출합니다." }, { q: "파일이 외부로 가나요?", a: "아니요. JSZip으로 브라우저 안에서 압축 해제·파싱하며 업로드되지 않습니다." }, { q: "한글·일본어·중국어도 되나요?", a: "네. 유니코드 텍스트 모두 정상 추출됩니다." }, { q: "이미지 속 글자는요?", a: "이미지에 박힌 글자는 텍스트가 아니라 추출 안 됩니다. 그건 [이미지 OCR] 도구가 필요합니다." }], addedAt: "2026-05-26" },
  { slug: "pptx-images", component: "PptxImagesTool", category: "document", icon: "🖼️", navTitle: "PPTX 이미지 추출", title: "PPTX 이미지 추출 - 파워포인트 속 모든 사진 저장", h1: "PPTX 이미지 추출기", description: "파워포인트(.pptx) 파일에 들어있는 모든 이미지(사진·로고·아이콘)를 원본 화질 그대로 추출해 한 번에 다운로드합니다. 발표 자료에서 이미지 재활용, 원본 화질 사진 회수, 디자인 소스 추출에 유용합니다. 브라우저에서 처리.", metaDescription: "PPTX 이미지 추출 무료. 파워포인트 속 모든 사진 원본 화질 추출, ZIP 다운로드.", howTo: ["PPTX 파일을 업로드합니다.", "포함된 모든 이미지가 썸네일로 표시됩니다.", "개별 저장하거나 전체를 ZIP으로 다운로드합니다."], faq: [{ q: "원본 화질로 나오나요?", a: "네. 슬라이드에 삽입된 원본 이미지 파일을 그대로 추출하므로 화질 손실이 없습니다." }, { q: "어떤 형식이 추출되나요?", a: "PNG·JPG·GIF·SVG·EMF 등 .pptx에 포함된 미디어를 모두 추출합니다." }, { q: "파일이 외부로 가나요?", a: "아니요. 브라우저 안에서 JSZip으로 압축 해제하며 업로드되지 않습니다." }, { q: "이미지 순서는?", a: "PPTX 내부 미디어 저장 순서로 표시됩니다. 슬라이드 등장 순서와 다소 다를 수 있습니다." }, { q: "동영상·오디오도 나오나요?", a: "삽입된 동영상·오디오 파일도 미디어로 추출됩니다." }, { q: "배경 이미지도 되나요?", a: "네. 슬라이드 배경으로 쓰인 이미지도 미디어 폴더에 있으면 추출됩니다." }], addedAt: "2026-05-26" },
  // ===== File → PDF converters =====
  { slug: "docx-to-pdf", component: "DocxToPdfTool", category: "document", icon: "📄", navTitle: "DOCX → PDF", title: "DOCX → PDF 변환 - 워드 문서를 PDF로 (무료, 업로드 없음)", h1: "DOCX → PDF 변환기", description: "워드(.docx) 파일을 브라우저 안에서 PDF로 변환합니다. 파일은 서버로 업로드되지 않고 기기에서만 처리되므로 계약서·이력서·내부 문서 같은 민감한 파일도 안전합니다. 본문 텍스트·표·이미지·기본 서식이 그대로 PDF로 보존됩니다. 워드 설치가 없는 PC, 모바일 빠른 변환, 메일/제출 전 형식 통일에 유용합니다.", metaDescription: "DOCX → PDF 무료 변환. 워드 파일을 브라우저에서 PDF로, 업로드 없음.", howTo: [".docx 파일을 드래그하거나 선택합니다.", "본문이 자동으로 PDF 형식으로 변환됩니다.", "[PDF 다운로드] 버튼을 눌러 받습니다."], faq: [{ q: "파일이 외부로 가나요?", a: "아니요. mammoth가 브라우저 안에서 .docx를 읽고, jsPDF가 PDF로 만듭니다. 어디로도 전송되지 않습니다." }, { q: "표·이미지·서식도 들어가나요?", a: "텍스트·표·이미지·기본 서식(굵게·기울임·제목)은 보존됩니다. 복잡한 레이아웃·고급 도형·SmartArt는 단순화되거나 빠질 수 있습니다." }, { q: "원본과 100% 똑같나요?", a: "빠른 변환용입니다. 한컴오피스나 워드의 정밀 PDF 출력과는 차이가 있을 수 있습니다. 중요 문서는 PDF 출력 후 확인하세요." }, { q: "구버전 .doc도 되나요?", a: "최신 .docx(2007+)만 지원합니다. .doc는 워드에서 .docx로 저장 후 변환하세요." }, { q: "한글·중문·일문도 깨끗하게 나오나요?", a: "네. 유니코드 텍스트가 그대로 PDF에 들어갑니다." }, { q: "여러 파일을 한 번에?", a: "현재는 1회에 1개 파일입니다. 여러 개라면 [PDF 합치기] 도구로 변환 후 합치세요." }], addedAt: "2026-06-02" },
  { slug: "xlsx-to-pdf", component: "XlsxToPdfTool", category: "document", icon: "📊", navTitle: "XLSX → PDF", title: "엑셀 XLSX → PDF 변환 - 시트를 깔끔한 표로 (무료, 업로드 없음)", h1: "엑셀(XLSX) → PDF 변환기", description: "엑셀(.xlsx/.xls/.csv) 파일의 모든 시트를 PDF의 표로 깔끔하게 변환합니다. 시트별로 페이지 구분, 행·열 그대로, 브라우저 안에서 처리되어 업로드 없음. 매출 자료·견적서·근태표·성적표 등을 빠르게 PDF로 만들어 제출·메일에 사용합니다.", metaDescription: "엑셀 XLSX → PDF 무료 변환. 시트별 페이지 구분, 표 그대로, 업로드 없음.", howTo: ["엑셀 파일(.xlsx, .xls, .csv)을 업로드합니다.", "시트가 자동으로 표 형식 PDF로 변환됩니다.", "[PDF 다운로드]로 받습니다."], faq: [{ q: "파일이 외부로 가나요?", a: "아니요. SheetJS가 브라우저 안에서 파일을 읽고 PDF로 변환합니다. 어디로도 전송되지 않습니다." }, { q: "수식 결과도 들어가나요?", a: "엑셀에 저장된 수식의 최종 값이 PDF에 표시됩니다." }, { q: "시트별로 페이지 나뉘나요?", a: "네. 각 시트가 별도 페이지로 변환됩니다. 빈 시트는 건너뜁니다." }, { q: ".csv 파일도 되나요?", a: "네. .csv도 표로 변환됩니다." }, { q: "큰 표는 자동 줄바꿈되나요?", a: "열이 많아 한 페이지에 안 들어가면 가로 A4로 자동 전환하거나 글자 크기를 줄여 맞춥니다. 너무 크면 가로로 잘릴 수 있으니 원본에서 적당히 정리하세요." }, { q: "셀 색·서식도 보존되나요?", a: "기본 텍스트와 표 구조 중심으로 변환되며, 색이나 일부 서식은 단순화될 수 있습니다." }], addedAt: "2026-06-02" },
  { slug: "pptx-to-pdf", component: "PptxToPdfTool", category: "document", icon: "📊", navTitle: "PPTX → PDF", title: "파워포인트 PPTX → PDF - 슬라이드를 PDF로 (무료)", h1: "PPTX → PDF 변환기", description: "파워포인트(.pptx) 파일의 각 슬라이드를 PDF의 한 페이지로 변환합니다. 브라우저 안에서 슬라이드를 렌더링한 뒤 PDF로 묶어줍니다. 발표 자료 제출·이메일 첨부·아카이브에 유용. 업로드 없음, 모든 처리는 기기 안에서.", metaDescription: "PPTX → PDF 무료 변환. 슬라이드별 1페이지, 업로드 없이 브라우저 처리.", howTo: [".pptx 파일을 업로드합니다.", "슬라이드가 차례로 PDF 페이지로 변환됩니다.", "[PDF 다운로드]로 받습니다."], faq: [{ q: "파일이 외부로 가나요?", a: "아니요. 브라우저 안에서 슬라이드를 렌더링하고 jsPDF로 묶습니다." }, { q: "원본 슬라이드와 똑같이 보이나요?", a: "빠른 변환용입니다. 텍스트·이미지·기본 도형은 잘 옮겨지지만, 복잡한 애니메이션·SmartArt·일부 폰트는 다르게 보일 수 있습니다. 정밀 변환은 파워포인트의 PDF 출력을 사용하세요." }, { q: "방향(가로/세로)?", a: "원본 슬라이드 비율에 맞춰 가로 A4(landscape)로 출력됩니다. 표준 16:9·4:3 슬라이드는 가로가 적합합니다." }, { q: "발표자 노트도 들어가나요?", a: "현재는 슬라이드 본문만 변환됩니다. 노트가 필요하면 [PPTX 텍스트 추출] 도구를 함께 사용하세요." }, { q: "구버전 .ppt도 되나요?", a: "최신 .pptx(2007+)만 지원. .ppt는 파워포인트에서 .pptx로 저장 후 변환하세요." }, { q: "슬라이드 수 제한?", a: "이론상 무제한이지만 슬라이드가 많을수록 PDF 생성 시간이 늘어납니다. 50~100장 정도까지가 쾌적합니다." }], addedAt: "2026-06-02" },
  { slug: "html-to-pdf", component: "HtmlToPdfTool", category: "document", icon: "🌐", navTitle: "HTML → PDF", title: "HTML → PDF 변환 - HTML/CSS 코드를 PDF 문서로", h1: "HTML → PDF 변환기", description: "HTML과 CSS 코드를 입력하면 렌더링 결과를 PDF로 다운로드합니다. 웹사이트 데모 캡처, 이메일 템플릿 PDF화, 위젯·시안 인쇄용 출력에 유용합니다. 폭과 방향을 조절할 수 있고, 모든 처리는 브라우저 안에서.", metaDescription: "HTML → PDF 무료. HTML/CSS 코드를 PDF로 렌더링, 업로드 없음.", howTo: ["HTML 코드를 붙여넣습니다.", "필요하면 폭과 방향을 조절합니다.", "[PDF 다운로드]로 받습니다."], faq: [{ q: "어떤 CSS가 지원되나요?", a: "대부분의 표준 CSS가 작동합니다. 일부 최신 기능(backdrop-filter 등)이나 외부 폰트는 제한적입니다." }, { q: "JavaScript는 실행되나요?", a: "보안상 JavaScript는 실행하지 않습니다. 순수 HTML+CSS 렌더링만." }, { q: "외부 이미지는?", a: "CORS 허용된 이미지만 가능. Base64 인라인 이미지가 안전합니다." }, { q: "한 페이지를 넘어가면?", a: "긴 콘텐츠는 자동으로 여러 페이지에 분할됩니다." }, { q: "[HTML → 이미지]와 차이?", a: "그 도구는 PNG, 이 도구는 PDF입니다. 인쇄·제출용은 PDF가 적합합니다." }, { q: "파일이 외부로 가나요?", a: "아니요. 모든 변환은 브라우저 안에서만 이루어집니다." }], addedAt: "2026-06-02" },
  { slug: "md-to-pdf", component: "MdToPdfTool", category: "document", icon: "📝", navTitle: "Markdown → PDF", title: "마크다운 → PDF 변환 - .md를 깔끔한 PDF 문서로", h1: "마크다운(.md) → PDF 변환기", description: "마크다운(.md) 텍스트를 깔끔한 PDF로 변환합니다. 헤딩·목록·코드 블록·인용·표·이미지·링크 모두 지원. 개발자 README·기술 문서·블로그 초안·강의 노트 PDF 변환에 유용. 브라우저 안에서 처리, 업로드 없음.", metaDescription: "마크다운 → PDF 무료. README·문서·노트를 PDF로, 업로드 없음.", howTo: ["마크다운 텍스트를 붙여넣거나 .md 파일을 업로드합니다.", "미리보기로 확인합니다.", "[PDF 다운로드]를 누릅니다."], faq: [{ q: "어떤 마크다운 문법이 지원?", a: "GFM(GitHub Flavored Markdown) 표준: 헤딩, 목록, 표, 코드 블록, 인용, 굵게/기울임, 링크, 이미지 등." }, { q: "코드 블록도 예쁘게 나오나요?", a: "네. 코드 폰트와 배경색이 적용됩니다. 신택스 하이라이트도 지원합니다." }, { q: "이미지는?", a: "마크다운에 인라인 이미지(URL 또는 Base64)가 있으면 PDF에 포함됩니다. 외부 이미지는 CORS 허용된 것만 가능." }, { q: "길이 제한?", a: "이론상 없지만 너무 길면 PDF 생성 시간이 늘어납니다. 일반 문서는 빠르게 처리됩니다." }, { q: "수식(LaTeX)도 되나요?", a: "기본 지원은 안 됩니다. 수식이 많으면 [마크다운+수식] 미리보기 도구로 우선 렌더링 후 인쇄→PDF 저장하세요." }, { q: "파일이 외부로 가나요?", a: "아니요. marked로 HTML 변환 후 jsPDF로 PDF를 만들며, 모두 브라우저 안에서 처리됩니다." }], addedAt: "2026-06-02" },
  // ===== PDF → File converters (reverse direction) =====
  { slug: "pdf-to-docx", component: "PdfToDocxTool", category: "document", icon: "📄", navTitle: "PDF → DOCX", title: "PDF → 워드(DOCX) 변환 - 원본 모양 그대로 (이미지 임베드)", h1: "PDF → 워드(DOCX) 변환 (원본 보존)", description: "PDF의 각 페이지를 고화질 이미지로 렌더링한 뒤 워드(.docx) 문서에 임베드합니다. 원본 모양·레이아웃·서체가 그대로 보존됩니다. 워드에서 열어 페이지 위에 텍스트 박스나 메모를 얹어 주석을 달 수 있습니다. **이미지 기반이라 본문 텍스트는 직접 편집할 수 없습니다** — 원본 그대로 보존하면서 워드에서 추가 작업을 하고 싶을 때 사용합니다. 정밀한 텍스트 편집이 필요하면 서버 OCR/ML 기반의 유료 서비스(Adobe, iLovePDF Pro)가 필요합니다.", metaDescription: "PDF → DOCX 무료. 페이지를 이미지로 워드에 임베드, 원본 모양 그대로.", howTo: ["PDF 파일을 드래그하거나 선택합니다.", "각 페이지가 고해상도 이미지로 렌더링되어 워드 문서의 각 페이지에 배치됩니다.", "[DOCX 다운로드]를 누릅니다.", "워드에서 열어 페이지 위에 텍스트 박스/메모를 얹어 사용할 수 있습니다."], faq: [{ q: "텍스트를 직접 편집할 수 있나요?", a: "이미지 기반이라 직접 편집은 안 됩니다. 본 도구의 강점은 '원본 모양 100% 보존'입니다. 워드에서 페이지 위에 텍스트 박스나 주석을 추가할 수 있습니다." }, { q: "왜 이미지 기반인가요?", a: "PDF를 워드의 단락·표·문단으로 완벽히 재구성하려면 서버 OCR + ML 레이아웃 분석이 필요합니다(Adobe Acrobat, iLovePDF Pro 등 유료 서비스가 그 방식). 클라이언트(브라우저)에서는 정밀 재구성이 불가능하므로 본 도구는 '원본 모양 보존'을 우선합니다." }, { q: "텍스트 편집이 필요하면?", a: "단순 텍스트 추출만 필요하면 [PDF 텍스트 추출] 도구를 쓰세요. 그 결과를 메모장이나 워드에 붙여넣고 편집하면 됩니다." }, { q: "왜 워드에서 텍스트 박스로?", a: "강의 자료에 코멘트 추가, 계약서에 주석 달기, 보고서 페이지에 메모 추가 등 원본은 그대로 두고 위에 정보만 얹는 용도에 유용합니다." }, { q: "파일이 외부로 가나요?", a: "아니요. pdfjs로 페이지를 렌더링하고 docx 라이브러리로 워드 파일을 만들며 모두 브라우저 안에서 처리됩니다." }, { q: "페이지 수 제한?", a: "수십 페이지까지 무난합니다. 100페이지 이상이면 생성에 시간이 걸리고 파일 용량이 커집니다." }], addedAt: "2026-06-02" },
  { slug: "pdf-to-pptx", component: "PdfToPptxTool", category: "document", icon: "📊", navTitle: "PDF → PPTX", title: "PDF → 파워포인트(PPTX) 변환 - 페이지별 슬라이드 이미지 (무료)", h1: "PDF → PPTX 변환기 (이미지 기반)", description: "PDF의 각 페이지를 고화질 이미지로 렌더링한 뒤 파워포인트(.pptx) 슬라이드 1장씩에 배치합니다. 원본 모양 그대로 보존되며, 파워포인트에서 열어 텍스트 박스를 위에 얹어 주석을 달거나 다른 슬라이드 사이에 끼워 사용하기 좋습니다. 이미지 기반이라 텍스트 편집은 안 됩니다.", metaDescription: "PDF → PPTX 무료. 페이지별 이미지 슬라이드, 원본 모양 그대로 보존.", howTo: ["PDF 파일을 업로드합니다.", "각 페이지가 고해상도 이미지로 슬라이드에 배치됩니다.", "[PPTX 다운로드]를 누릅니다.", "파워포인트에서 열어 텍스트 박스나 도형을 추가할 수 있습니다."], faq: [{ q: "텍스트를 편집할 수 있나요?", a: "이미지 기반이라 직접 편집은 안 됩니다. 단순 텍스트 추출만 필요하면 [PDF 텍스트 추출] 도구를 쓰세요. 본 도구는 '원본 모양 보존'이 강점입니다." }, { q: "왜 이미지 기반인가요?", a: "PDF를 파워포인트의 도형·텍스트 박스로 완벽히 재구성하는 건 서버 ML이 필요합니다(유료 서비스). 본 도구는 원본 모양 100% 보존을 우선해 페이지를 이미지로 슬라이드에 박습니다. 발표 자료의 일부 페이지를 슬라이드에 끼워 넣을 때 유용." }, { q: "슬라이드 방향은?", a: "원본 PDF 페이지 비율에 맞춰 자동 결정됩니다. 일반 A4 PDF는 세로, 와이드 PDF는 가로." }, { q: "고해상도로 나오나요?", a: "기본 2배 스케일로 렌더링되어 큰 화면 발표에서도 깨끗합니다." }, { q: "파일이 외부로 가나요?", a: "아니요. pdfjs로 렌더링하고 pptxgenjs가 .pptx를 만들며, 모두 브라우저 안에서 처리됩니다." }, { q: "페이지 수 제한?", a: "수십 페이지까지 무난합니다. 100페이지 이상이면 생성에 시간이 걸립니다." }], addedAt: "2026-06-02" },
  { slug: "pdf-to-html", component: "PdfToHtmlTool", category: "document", icon: "🌐", navTitle: "PDF → HTML", title: "PDF → HTML 변환 - 페이지를 이미지로 임베드한 웹페이지", h1: "PDF → HTML 변환 (원본 보존)", description: "PDF의 각 페이지를 고화질 이미지로 렌더링한 뒤 HTML 페이지에 임베드합니다. 원본 모양·레이아웃이 그대로 보존되며, 브라우저에서 PDF처럼 스크롤하며 볼 수 있습니다. 웹사이트에 PDF를 그대로 게재하거나 아카이브용 단일 HTML 파일이 필요할 때 적합. **이미지 기반이라 텍스트 선택·복사는 안 됩니다** — 텍스트 추출이 필요하면 기존 [PDF 텍스트 추출] 도구를 쓰세요.", metaDescription: "PDF → HTML 무료. 페이지를 이미지로 HTML에 임베드, 원본 모양 보존.", howTo: ["PDF 파일을 업로드합니다.", "각 페이지가 고해상도 이미지로 렌더링되어 HTML에 임베드됩니다.", "[HTML 다운로드]로 단일 파일을 받거나 미리보기로 확인합니다."], faq: [{ q: "텍스트 선택·복사 가능?", a: "이미지 기반이라 안 됩니다. 텍스트가 필요하면 [PDF 텍스트 추출] 도구를 사용하세요. 본 도구의 강점은 '원본 모양 100% 보존'입니다." }, { q: "왜 이미지 기반인가요?", a: "PDF의 정밀 레이아웃(폰트·여백·다단 구조)을 HTML/CSS로 재구성하려면 서버 ML이 필요합니다. 브라우저 클라이언트에서는 정밀 재구성이 불가능하므로 원본을 이미지로 보존합니다." }, { q: "어떤 용도에 적합?", a: "PDF 내용을 그대로 웹페이지에 게재(아카이브용), 메일에 단일 HTML 파일로 첨부, 정밀한 인쇄 미리보기 등." }, { q: "파일 용량이 큰가요?", a: "각 페이지가 이미지로 들어가므로 텍스트 추출 방식보다 크지만, 모든 페이지를 단일 HTML에 담을 수 있어 공유가 편합니다." }, { q: "파일이 외부로 가나요?", a: "아니요. pdfjs가 브라우저에서 페이지를 렌더링하고 HTML을 만듭니다." }, { q: "[PDF → 이미지 변환]과 차이는?", a: "그 도구는 PNG 파일 여러 개로 추출, 본 도구는 단일 HTML 파일에 모든 페이지를 묶어 임베드합니다. 웹 공유·아카이브엔 본 도구가 편합니다." }], addedAt: "2026-06-02" },

  { slug: "txt-to-pdf", component: "TxtToPdfTool", category: "document", icon: "📃", navTitle: "TXT → PDF", title: "텍스트(.txt) → PDF 변환 - 단순 텍스트를 PDF로", h1: "텍스트(.txt) → PDF 변환기", description: "단순 텍스트 파일(.txt)이나 입력한 텍스트를 깔끔한 PDF로 변환합니다. 글자 크기·줄 간격·여백·방향을 조절할 수 있고, 자동 줄바꿈으로 긴 문장도 깔끔하게. 메모·로그·코드 출력·발표 대본을 빠르게 PDF로 만들 때 유용합니다.", metaDescription: "TXT → PDF 무료. 텍스트를 깔끔한 PDF로, 글자 크기·여백 조절.", howTo: [".txt 파일을 업로드하거나 텍스트를 붙여넣습니다.", "글자 크기·여백을 조절합니다.", "[PDF 다운로드]를 누릅니다."], faq: [{ q: "긴 문장이 잘리나요?", a: "자동 줄바꿈으로 페이지 폭에 맞춰 줄을 나눕니다. 길이가 길면 여러 페이지로 분할됩니다." }, { q: "한글·중문·일문도 되나요?", a: "네. 유니코드 텍스트가 그대로 PDF에 들어갑니다." }, { q: "고정폭(monospace) 폰트도 가능?", a: "기본 폰트와 고정폭 폰트(코드 출력용)를 선택할 수 있습니다." }, { q: "어떤 용도에 적합?", a: "메모, 로그 파일 보관, 코드 일부 출력, 발표 대본, 책 일부 인용 등 단순 텍스트의 PDF화에 적합합니다." }, { q: "파일이 외부로 가나요?", a: "아니요. 모든 변환은 브라우저 안에서만 이루어집니다." }, { q: "[마크다운 → PDF]와 차이?", a: "마크다운은 서식(헤딩·표·코드 블록 등)이 있는 텍스트, TXT는 서식 없는 평문입니다. 단순 텍스트면 이 도구가 빠르고 가볍습니다." }], addedAt: "2026-06-02" },

  { slug: "number-tags", component: "NumberTagsTool", category: "document", icon: "🏷️", navTitle: "번호표 만들기", title: "번호표 생성기 - A4 PDF 종이 절약 (1-200 연속 번호 라벨)", h1: "번호표 생성기 (A4 PDF, 종이 절약 배치)", description: "원하는 시작·끝 번호(예: 1-200)와 배경색·글자색을 지정하면 A4 종이 한 장에 N×M칸으로 빽빽하게 배치해 PDF로 다운로드합니다. 종이를 최대한 아끼는 격자 인쇄. 칸 수(열·행), 여백, 칸 간격, 글자 크기, 접두/접미어, 모서리 둥글기, 가로/세로 방향 조절. 행사 입장권·대기 번호표·교실 학번·바자회 부스 번호·사물함 라벨·복권 추첨에 유용합니다. 브라우저에서 처리.", metaDescription: "번호표 PDF 무료. A4 종이에 N×M 배치로 종이 절약, 배경색·글자색·여백 조절.", howTo: ["시작·끝 번호를 입력합니다 (예: 1-200).", "배경색·글자색을 고르고 열(cols)·행(rows)을 정해 A4에 몇 칸을 넣을지 정합니다.", "여백·칸 간격으로 가위질 여유를 확보합니다.", "[PDF 다운로드]를 누르면 여러 장의 A4 PDF가 생성됩니다.", "인쇄해서 가위로 잘라 사용합니다."], faq: [{ q: "여러 장을 겹쳐서 한 번에 잘라도 되나요?", a: "네. '겹쳐서 한 번에 자르기(스택)' 배치를 고르면 같은 칸이 장마다 1씩 커지도록 찍혀서, 인쇄물을 겹쳐 재단기로 한 번에 잘라도 각 칸 묶음이 연속 번호(1번 칸 1~50, 2번 칸 51~100 …)가 됩니다. 한 장씩 가위로 자를 때는 '장별 순서'를 고르세요." }, { q: "종이는 얼마나 아낄 수 있나요?", a: "5×8(40칸)이면 A4 한 장에 40개, 200개 라벨이 5장으로 끝납니다. 4×10(40칸), 6×10(60칸) 같은 조합도 가능. 칸을 많이 넣을수록 종이 절약." }, { q: "PDF는 어떻게 만들어지나요?", a: "브라우저 안에서 A4 크기로 페이지를 그린 뒤 jsPDF가 PDF로 묶어줍니다. 외부 서버 전송 없이 안전하게 처리됩니다." }, { q: "최대 몇 개까지 만들 수 있나요?", a: "한 번에 10,000개까지 만들 수 있습니다(40칸 기준 250장). 그보다 많으면 시작 번호를 바꿔 나눠서 만드세요. 페이지가 많을수록 PDF 파일이 커집니다." }, { q: "0을 앞에 채워주는 옵션은?", a: "자리수 맞춤으로 1→001, 12→012처럼 0으로 채울 수 있습니다. 정렬과 인쇄에 깔끔합니다." }, { q: "한글 접미어(예: '번', '호')도 되나요?", a: "네. 접두어·접미어에 한글·영문·숫자·기호 모두 입력 가능. 'No.001번' 같은 식." }, { q: "가로(landscape) 방향도 되나요?", a: "방향(세로/가로) 선택 옵션이 있습니다. 가로 A4는 한 행에 더 많은 칸을 넣기 좋습니다." }, { q: "행사 입장권으로 적합한가요?", a: "추첨·복권용 번호표, 행사 입장권, 사물함 번호, 부스 번호 등에 적합합니다. 가위로 잘라 사용하세요." }], addedAt: "2026-06-01" },
  { slug: "teleprompter", component: "TeleprompterTool", category: "document", icon: "🎤", navTitle: "텔레프롬프터", title: "텔레프롬프터 - 발표 스크립트 자동 스크롤 (뉴스 앵커 스타일)", h1: "텔레프롬프터 (발표 스크립트 자동 스크롤)", description: "뉴스 앵커가 쓰는 텔레프롬프터처럼 발표 스크립트를 자동으로 한 줄씩 올려줍니다. 속도·글자크기·색·미러 모드·전체화면을 조절할 수 있고, 스페이스바로 일시정지·↑↓로 속도 조절. 강연·유튜브·라이브 방송·면접 연습·웨딩 사회·결혼식 축사·기조연설 같은 발표에 유용합니다. 브라우저 안에서만 처리.", metaDescription: "텔레프롬프터 무료. 발표 스크립트 자동 스크롤, 속도·글자크기 조절, 전체화면, 업로드 없음.", howTo: ["스크립트를 붙여넣습니다.", "글자 크기와 속도를 조절합니다.", "▶ 재생 버튼을 누르면 텍스트가 위로 자동 스크롤됩니다.", "스페이스바로 일시정지, ↑↓로 속도 조절, F로 전체화면.", "실제 텔레프롬프터 거울 장비를 쓰면 미러 모드를 켜세요."], faq: [{ q: "어떤 단축키가 있나요?", a: "스페이스 = 재생·일시정지, ↑ = 속도 ↑, ↓ = 속도 ↓, R = 처음으로, F = 전체화면, Esc = 전체화면 종료." }, { q: "미러 모드는 왜 필요한가요?", a: "전문 텔레프롬프터는 카메라 앞에 반투명 거울을 놓고 그 아래 화면을 비춰 사용합니다. 그래서 텍스트가 좌우 반전되어야 거울에 정상으로 보입니다. 일반 화면만 쓸 거면 끄세요." }, { q: "속도는 어떻게 정해요?", a: "발표 속도는 분당 단어 수(WPM)로 결정됩니다. 한국어 발표는 보통 250-300자/분, 영어는 130-160단어/분. 도구의 속도 슬라이더로 직접 맞춰보고 편한 값을 찾으세요." }, { q: "지금 읽는 줄을 강조해 주나요?", a: "화면 중앙에 가이드 라인이 있어 그 줄을 지금 읽으면 됩니다. 다른 줄은 살짝 흐리게 표시되어 시선이 분산되지 않습니다." }, { q: "전체화면이 안 돼요.", a: "브라우저 보안상 사용자 제스처(버튼 클릭) 후에만 전체화면이 가능합니다. F 키나 [전체화면] 버튼을 직접 눌러주세요." }, { q: "스크립트가 외부로 가나요?", a: "아니요. 모든 처리가 브라우저 안에서 일어나며 어디로도 전송되지 않습니다. 민감한 발표 내용도 안전합니다." }, { q: "스크립트를 저장해 두려면?", a: "현재는 일회용입니다. 다음 방문 시 사용하려면 텍스트를 별도 메모장에 저장해 두세요. (자동 저장 기능은 추후 추가 예정)" }], addedAt: "2026-05-28" },
  { slug: "pptx-info", component: "PptxInfoTool", category: "document", icon: "ℹ️", navTitle: "PPTX 정보 보기", title: "PPTX 정보 - 슬라이드 수 · 작성자 · 생성일 확인", h1: "PPTX 파일 정보 보기", description: "파워포인트(.pptx) 파일의 슬라이드 수, 제목, 작성자, 생성·수정 일시, 사용 프로그램 등 메타데이터를 확인합니다. 파일 출처 확인, 제출 전 작성자 정보 점검, 슬라이드 수 빠른 확인에 유용합니다. 브라우저에서 처리.", metaDescription: "PPTX 정보 무료 확인. 슬라이드 수·작성자·생성일·수정일 메타데이터, 업로드 없음.", howTo: ["PPTX 파일을 업로드합니다.", "슬라이드 수·작성자·생성일 등 정보가 표시됩니다."], faq: [{ q: "어떤 정보가 나오나요?", a: "슬라이드 수, 제목, 작성자, 마지막 수정자, 생성·수정 일시, 작성 프로그램, 회사명 등 docProps 메타데이터입니다." }, { q: "작성자 정보를 지우려면?", a: "이 도구는 확인용입니다. 메타데이터 제거는 파워포인트의 '문서 검사' 기능을 사용하세요." }, { q: "파일이 외부로 가나요?", a: "아니요. 브라우저 안에서 docProps XML을 파싱하며 업로드되지 않습니다." }, { q: "슬라이드 수가 실제와 다를 수 있나요?", a: "숨겨진 슬라이드 포함 여부에 따라 다를 수 있습니다. 기본적으로 전체 슬라이드 수를 셉니다." }, { q: "제출 전 왜 확인하나요?", a: "작성자·회사명에 개인정보나 이전 파일 흔적이 남아있는 경우가 많아, 외부 제출 전 점검하면 좋습니다." }], addedAt: "2026-05-26" },

  // ===== Batch I (2026-05-18 추가 6종) =====
  { slug: "car-tax", component: "CarTaxTool", category: "calc", icon: "🚗", navTitle: "자동차세 계산기", title: "자동차세 계산기 - 배기량 · 차령 · 영업용 / 하이브리드 / 전기차", h1: "자동차세 계산기 (2026 한국 지방세법)", description: "자동차 배기량과 차령으로 연간 자동차세와 지방교육세를 계산합니다. 일반 승용차·영업용·하이브리드·전기차 모두 지원. 매년 6월·12월 납부 시기에 정확한 세액 가늠에 자주 쓰입니다.", metaDescription: "자동차세 계산 무료. 배기량·차령·영업용·하이브리드·전기차, 2026 한국 기준.", howTo: ["차량 종류(일반/하이브리드/전기차)를 선택합니다.", "배기량(cc)과 차령(년)을 입력합니다.", "영업용 여부를 체크합니다.", "연간 자동차세와 반기 납부액이 표시됩니다."], faq: [{ q: "차령 경감이 뭐예요?", a: "3년차부터 매년 5%씩 자동차세가 경감되며, 12년차 이상은 최대 50%까지 경감됩니다. 노후 차량 보유자에게 유리한 제도입니다." }, { q: "지방교육세는 왜 더 붙어요?", a: "자동차세의 30%가 지방교육세로 자동 부과됩니다. 별도 신고 없이 함께 납부됩니다." }, { q: "전기차는 왜 13만원 고정이에요?", a: "전기차는 배기량이 없어 차종 무관 연 13만원이 적용됩니다. 친환경차 혜택입니다." }, { q: "하이브리드 50% 경감 언제까지?", a: "현재 2026년 기준 하이브리드 50% 경감이 유지 중입니다. 정부 정책 변경 가능성 있으니 지방자치단체 안내 확인 필요." }, { q: "영업용은 왜 세율이 낮나요?", a: "택시·렌터카 등 영업용은 사업용 자산으로 분류되어 일반 승용 대비 낮은 세율이 적용됩니다." }, { q: "연납 할인이 있나요?", a: "연초(1월) 일시 납부 시 약 10% 할인됩니다. 본 도구는 미반영 — 별도로 ×0.9 적용하면 됩니다." }], addedAt: "2026-05-18" },
  { slug: "severance-pay", component: "SeverancePayTool", category: "calc", icon: "💼", navTitle: "퇴직금 계산기", title: "퇴직금 계산기 - 근로기준법 기준 (평균임금·재직일수·상여 반영)", h1: "퇴직금 예상 계산기", description: "재직 기간·평균임금·상여·연차수당으로 근로기준법 기준 퇴직금을 계산합니다. 이직·은퇴·퇴사 결정 전 예상 금액 가늠, 회사 지급액 검증, DC형 vs DB형 비교에 자주 쓰입니다.", metaDescription: "퇴직금 계산 무료. 평균임금 일급, 30일분 × 재직년수.", howTo: ["재직 기간(년·월·일)을 입력합니다.", "퇴직 직전 3개월 월 평균임금을 입력합니다.", "(선택) 상여금·연차수당을 입력합니다.", "예상 퇴직금이 표시됩니다."], faq: [{ q: "1년 미만은 퇴직금이 없나요?", a: "근로기준법상 1년 이상 근속자에게만 퇴직금 지급 의무가 있습니다. 1년 미만은 회사 내규에 따라 지급할 수 있어요." }, { q: "평균임금 산정?", a: "퇴직 직전 3개월간 받은 임금 총액 ÷ 그 기간의 총 일수. 상여금은 3/12, 연차수당은 3/12 비율로 합산합니다." }, { q: "평균임금 vs 통상임금 어느 게 적용?", a: "둘 중 더 큰 금액이 적용됩니다. 야간·휴일 근무가 많은 직군은 평균임금이, 단순 기본급 위주는 통상임금이 클 수 있습니다." }, { q: "퇴직소득세는?", a: "이 도구는 세전 금액입니다. 퇴직소득세는 근속연수공제 등이 적용돼 일반 소득세보다 낮은 편이며, 정확한 세후 금액은 홈택스에서 확인할 수 있습니다." }, { q: "DB형·DC형 퇴직연금은?", a: "DB형은 이 계산과 같은 방식, DC형은 회사가 매년 적립한 금액 + 운용 수익으로 결정됩니다. 형태에 따라 결과가 다를 수 있습니다." }, { q: "정확한 금액을 알려면?", a: "회사 인사팀 또는 노동부 퇴직금 계산기(고용노동부 사이트)를 활용하세요. 본 도구는 빠른 추정용입니다." }], addedAt: "2026-05-18" },
  { slug: "income-tax", component: "IncomeTaxTool", category: "calc", icon: "📊", navTitle: "종합소득세 계산", title: "종합소득세 간이 계산기 - 누진세율 · 소득공제 (2026)", h1: "종합소득세 간이 계산기", description: "연 수입과 필요경비·소득공제로 종합소득세를 간이 계산합니다. 5월 종소세 신고 시즌 자가 점검, 사업·임대·프리랜서 소득 세금 가늠, 세무사 상담 전 사전 검토에 자주 쓰입니다.", metaDescription: "종합소득세 무료 계산. 누진세율, 8단계 과세표준, 2026 기준.", howTo: ["연 총 수입을 입력합니다.", "필요경비(사업·임대)와 소득공제를 입력합니다.", "산출세액과 지방소득세 포함 최종 납부세액을 확인합니다."], faq: [{ q: "누진세율은 어떻게 작동?", a: "과세표준 구간별로 6%(1,400만원 이하) ~ 45%(10억 초과) 누진세율이 적용됩니다. 도구가 자동으로 누진공제액을 빼서 계산합니다." }, { q: "근로소득자도 종소세를 내요?", a: "근로소득만 있고 회사에서 원천징수·연말정산이 완료됐다면 별도 종소세 신고가 불필요합니다. 사업·임대·금융 등 부가 소득이 있을 때 합산 신고합니다." }, { q: "이 계산이 정확한가요?", a: "근로소득공제·세액공제(자녀·기부·교육비 등) 같은 복잡한 항목이 단순화됐습니다. 실제 신고는 홈택스 모의계산기나 세무사 상담을 권장합니다." }, { q: "한계세율과 실효세율?", a: "한계세율은 마지막 구간 세율, 실효세율은 (총 납부세액 ÷ 총 수입). 예: 5천만원 수입에 한계세율 15%여도 실효세율은 ~9% 정도입니다." }, { q: "5월 신고를 안 하면?", a: "신고 의무가 있는데 안 하면 가산세(무신고 20%+) + 가산세 이자가 붙습니다. 모르면 세무서·홈택스에 문의하세요." }, { q: "지방소득세는 별도?", a: "산출세액의 10%가 지방소득세로 추가됩니다. 본 도구는 자동으로 합산해 최종 납부세액을 표시합니다." }], addedAt: "2026-05-18" },
  { slug: "stt", component: "SttTool", category: "text", icon: "🎙️", navTitle: "음성 → 텍스트 (STT)", title: "음성 → 텍스트 변환 (STT) - 한국어·다국어 실시간 받아쓰기", h1: "음성 → 텍스트 (STT)", description: "마이크로 말하면 텍스트로 변환합니다. 한국어·영어·일본어·중국어 등 다국어 지원. 회의 받아쓰기, 인터뷰 녹취, 강의 노트, 외국어 발음 연습, 손이 자유롭지 않을 때 입력에 자주 쓰입니다.", metaDescription: "음성 텍스트 변환 무료. 한국어·영어 STT, 브라우저 내장 Web Speech API.", howTo: ["언어를 선택합니다.", "🎤 녹음 시작을 누르고 마이크 권한을 허용합니다.", "말하면 텍스트가 실시간 표시됩니다.", "복사하거나 .txt로 저장합니다."], faq: [{ q: "Web Speech API 지원 브라우저?", a: "Chrome·Edge·Safari(부분 지원)에서 잘 작동합니다. Firefox는 미지원. 모바일 Chrome도 동작합니다." }, { q: "녹음 파일을 업로드해서 변환?", a: "이 도구는 마이크 실시간 입력만 지원합니다. 녹음된 파일 변환은 Whisper API 같은 서버 기반 도구가 필요합니다." }, { q: "정확도가 떨어져요. 왜?", a: "(1) 마이크 품질, (2) 주변 소음, (3) 말 속도·발음, (4) 전문 용어가 영향을 줍니다. 천천히 또렷이 말하면 정확도가 올라갑니다." }, { q: "내 음성이 외부로 가나요?", a: "Chrome은 Google 서버, Safari는 Apple 서버에서 변환합니다. 브라우저 자체 처리가 아니라 음성 데이터가 해당 회사로 전송됩니다. 민감한 내용은 주의하세요." }, { q: "구두점은 자동으로?", a: "일부 브라우저는 자동 구두점을 지원하지만 한국어는 거의 안 됩니다. 변환 후 직접 편집하거나 음성으로 '쉼표', '마침표'라고 말해보세요." }, { q: "오프라인에서도 됩니까?", a: "Web Speech API는 보통 인터넷 연결이 필요합니다. 오프라인 STT는 별도 라이브러리·앱이 필요합니다." }], addedAt: "2026-05-18" },
  { slug: "ocr", component: "OcrTool", category: "image", icon: "🔍", navTitle: "이미지 OCR (글자 추출)", title: "이미지 OCR - 사진 속 글자 추출 (한국어 · 영어 · 일본어)", h1: "이미지 OCR (광학 문자 인식)", description: "사진 속 글자를 텍스트로 추출합니다. Tesseract.js 한국어 모델 사용. 영수증 입력, 책·문서 사진 디지털화, 화면 캡처 글자 복사, 명함 정보 추출, 손글씨 인식(제한)에 자주 쓰입니다.", metaDescription: "이미지 OCR 무료. 한국어·영어·일본어 글자 추출, Tesseract.js.", howTo: ["글자가 있는 이미지를 업로드합니다.", "언어를 선택합니다 (한국어 / 영어 / 한+영 / 일본어 등).", "OCR 시작 버튼을 누릅니다.", "인식된 텍스트를 복사하거나 .txt로 저장합니다."], faq: [{ q: "정확도는 어느 정도?", a: "고해상도·인쇄체 한국어 문서는 90%+ 정확도. 손글씨·기울어진 사진·저해상도는 50~70%로 떨어집니다. 신뢰도 점수가 함께 표시됩니다." }, { q: "처음 사용 시 왜 느려요?", a: "첫 사용 시 한국어 학습 데이터(~10MB)를 다운로드합니다. 이후엔 브라우저 캐시되어 빨라집니다." }, { q: "PDF 안의 글자도 추출?", a: "PDF는 이 도구로 직접 처리되지 않습니다. [PDF → 이미지] 도구로 변환 후 OCR을 적용하세요. 단, 디지털 PDF는 [PDF 텍스트 추출]이 OCR보다 정확합니다." }, { q: "여러 장을 한 번에?", a: "현재는 한 장씩 처리됩니다. 일괄 OCR은 처리 시간이 길어 데스크톱 도구가 적합합니다." }, { q: "한자·일본어도 지원?", a: "일본어, 중국어 간체·번체 모델을 선택할 수 있습니다. 한자는 일본어 또는 중국어 모델 사용 권장." }, { q: "이미지가 외부로 가나요?", a: "아니요. Tesseract.js는 WebAssembly로 브라우저 안에서 처리되며 이미지·결과 모두 외부로 전송되지 않습니다." }, { q: "OCR이 잘 되는 이미지?", a: "(1) 글자 크기 12pt 이상, (2) 배경과 글자 대비 뚜렷, (3) 똑바로 촬영, (4) 흔들림 없는 사진. 책 페이지를 평평하게 펴고 위에서 찍는 게 가장 정확합니다." }], addedAt: "2026-05-18" },
  { slug: "real-estate-tax", component: "RealEstateTaxTool", category: "calc", icon: "🏘️", navTitle: "부동산 세금 계산", title: "부동산 세금 계산기 - 취득세 · 양도세 · 재산세 (한국)", h1: "부동산 세금 계산기 (취득세 · 양도세 · 재산세)", description: "주택 매매·양도·보유 시 부담하는 한국 세금을 한 화면에서 계산합니다. 1주택·다주택, 보유 기간, 양도차익에 따른 누진세율, 시가표준액 기반 재산세까지. 부동산 거래 결정 전 세부담 가늠에 자주 쓰입니다.", metaDescription: "부동산 세금 계산 무료. 취득세·양도세·재산세, 1주택·다주택, 2026 한국 기준.", howTo: ["탭에서 계산할 세금(취득세/양도세/재산세)을 고릅니다.", "주택 여부, 가격, 보유 기간 등을 입력합니다.", "본세·지방교육세·농특세 등 세부 항목과 총액이 표시됩니다."], faq: [{ q: "취득세율은 어떻게?", a: "1주택 6억 이하 1%, 6~9억 2%, 9억 초과 3%. 다주택은 8~12%. 비주택(상가·오피스텔)은 4% 일률 적용." }, { q: "양도세 1주택 비과세 조건?", a: "1세대 1주택 + 2년 이상 보유 + 12억원 이하면 비과세. 조정지역은 2년 거주 요건도 있음. 이 도구는 단순화된 추정." }, { q: "장기보유특별공제가 뭐예요?", a: "3년 이상 보유 시 6%부터 시작해 매년 누적, 15년 보유 시 30% 공제. 1세대 1주택은 별도 우대 공제(거주 + 보유 기간 합산 최대 80%)." }, { q: "재산세와 종부세 차이?", a: "재산세는 지자체가 모든 주택에 부과, 종부세(종합부동산세)는 공시가 9억원 초과(1주택 12억) 시 추가 부과. 종부세는 별도 계산이 필요합니다." }, { q: "이 결과 그대로 신고해도 되나요?", a: "추정용입니다. 조정지역·생애최초·중과세·일시적 2주택 등 예외가 많아 위택스·홈택스·세무사 상담이 안전합니다." }, { q: "공시가는 어디서?", a: "국토교통부 부동산공시가격알리미(realtyprice.kr) 또는 정부24에서 조회 가능. 보통 실거래가의 70~80% 수준." }], addedAt: "2026-05-18" },
  { slug: "youtube-thumbnail", component: "YoutubeThumbnailTool", category: "image", icon: "📺", navTitle: "유튜브 썸네일 다운로드", title: "YouTube 썸네일 다운로더 - URL → 4종 해상도 PNG/JPG", h1: "YouTube 썸네일 다운로더", description: "YouTube 영상 URL이나 ID를 입력하면 자동 생성된 썸네일 이미지를 5가지 해상도(Max·Standard·High·Medium·Default)로 받습니다. 블로그·SNS에 영상 미리보기 임베드, 영상 캡션 디자인 참고, 본인 영상 썸네일 백업에 자주 쓰입니다.", metaDescription: "유튜브 썸네일 다운로드 무료. URL·ID 입력, 5가지 해상도, 즉시 저장.", howTo: ["YouTube 영상 URL 또는 11자리 영상 ID를 입력합니다.", "5가지 해상도 중 원하는 사이즈의 다운로드 버튼을 누릅니다."], faq: [{ q: "어떤 URL 형식을 지원하나요?", a: "youtube.com/watch?v=..., youtu.be/..., youtube.com/shorts/..., youtube.com/embed/... 모두 지원. 11자리 영상 ID 직접 입력도 가능." }, { q: "왜 maxresdefault가 없을 때가 있어요?", a: "업로더가 직접 1280×720+ 썸네일을 설정하지 않았거나, 오래된 저화질 영상이면 maxresdefault가 없을 수 있습니다. 그럴 땐 sddefault(640×480)가 가장 큰 사이즈." }, { q: "Shorts 썸네일도 됩니까?", a: "네. Shorts URL을 입력하면 자동 인식됩니다. 다만 Shorts는 세로 영상이라 썸네일이 가로형으로 잘려 보일 수 있어요." }, { q: "저작권 문제?", a: "본인 업로드 영상 또는 정당한 인용·교육·비평 목적으로 사용하세요. 타인 영상 썸네일을 무단 상업 이용은 저작권 침해입니다." }, { q: "이미지가 외부로 가나요?", a: "썸네일은 YouTube CDN(i.ytimg.com)에서 직접 받아옵니다. 입력한 URL은 외부로 전송되지 않습니다." }], addedAt: "2026-05-18" },
  { slug: "subtitle", component: "SubtitleTool", category: "video", icon: "💬", navTitle: "자막 변환·편집 (SRT/VTT)", title: "자막 SRT ↔ VTT 변환 · 시간 오프셋 편집", h1: "자막 변환·편집 (SRT · VTT · TXT)", description: "SRT(SubRip)와 VTT(WebVTT) 자막 파일을 양방향 변환하고 시간 오프셋을 일괄 조정합니다. 영상과 자막이 안 맞을 때 싱크 맞추기, 자막 본문 텍스트만 추출, 강의·인터뷰 영상 자막 작업에 자주 쓰입니다.", metaDescription: "자막 변환 무료. SRT ↔ VTT, 시간 오프셋, 본문 추출.", howTo: ["자막 텍스트를 붙여넣거나 .srt/.vtt 파일을 업로드합니다.", "필요하면 시간 오프셋(초)을 조절합니다.", "변환 형식(SRT/VTT/TXT)을 선택하고 다운로드합니다."], faq: [{ q: "SRT와 VTT 차이?", a: "SRT는 옛 표준 (영화·DVD 위주), VTT는 웹 표준 (HTML5 video, 스타일 지원). 둘 다 시각·텍스트 구조는 비슷하고, 구분자(쉼표 vs 점)와 헤더(WEBVTT)만 다릅니다." }, { q: "자막이 영상보다 빠르거나 느려요. 어떻게?", a: "시간 오프셋에 +1.5(1.5초 늦춤) 또는 -2.0(2초 당김) 같이 입력하면 모든 자막 시간이 일괄 조정됩니다." }, { q: "본문 텍스트만 뽑으려면?", a: "변환 형식을 TXT로 선택하면 시간 정보 빠지고 본문만 추출됩니다. ChatGPT·번역기 입력에 편리." }, { q: "내용 직접 편집 가능?", a: "왼쪽 자막 텍스트를 직접 수정하면 즉시 결과에 반영됩니다." }, { q: "큰 자막 파일도 됩니까?", a: "수천 줄 자막도 즉시 처리됩니다. 모든 처리는 브라우저 안에서 일어나며 외부 전송 없음." }, { q: "다른 자막 포맷(ASS, SSA)도?", a: "현재 SRT/VTT만 지원합니다. ASS/SSA는 스타일 정보가 많아 별도 변환 도구가 필요합니다." }], addedAt: "2026-05-18" },
  { slug: "color-palette", component: "ColorPaletteTool", category: "image", icon: "🎨", navTitle: "컬러 팔레트 생성기", title: "컬러 팔레트 랜덤 생성기 - 보색 · 유사색 · 삼각 · 사각", h1: "컬러 팔레트 생성기 (조화 규칙)", description: "색 조화 규칙(단색·유사색·보색·삼각·사각)에 따라 5가지 색을 한 번에 생성합니다. 클릭하면 HEX 코드가 복사됩니다. 디자인 시안 초기 컬러 결정, 브랜드 컬러 후보 탐색, 발표 자료·블로그 디자인에 자주 쓰입니다.", metaDescription: "컬러 팔레트 무료 생성. 보색·유사색·삼각·사각 조화 규칙, 클릭 복사.", howTo: ["조화 규칙을 선택합니다 (랜덤/단색/유사색/보색/삼각/사각).", "새 팔레트 생성 버튼으로 마음에 들 때까지 반복합니다.", "원하는 색을 클릭해 HEX 코드를 복사합니다."], faq: [{ q: "각 모드 의미?", a: "단색조: 한 색의 명도 변화. 유사색: 색상환 30도 이내. 보색: 정반대 색. 삼각: 120도 간격. 사각: 90도 간격." }, { q: "어떤 게 가장 안전한 조합?", a: "유사색이 무난하고 부드러움. 보색은 강조 효과 좋지만 잘못 쓰면 촌스러움. 삼각·사각은 균형 잡힌 다채로운 디자인에 적합." }, { q: "Adobe Color와 비교?", a: "Adobe Color는 더 정교한 컨트롤·이미지 기반 추출 등이 있지만 가입 필요. 본 도구는 빠른 영감용으로 가입 없이 즉시 사용." }, { q: "기존 브랜드 컬러에 어울리는 팔레트?", a: "본 도구는 랜덤 생성이라 특정 베이스 컬러를 지정하는 기능은 별도. 그 색을 추출하려면 [이미지 색상 추출] 도구를 함께 사용하세요." }, { q: "접근성(WCAG)도 고려?", a: "본 도구는 미적 조화 위주입니다. 글자·배경 대비 검사가 필요하면 [WCAG 색 대비 검사기]를 함께 활용하세요." }, { q: "결과를 CSS 변수로 만들면?", a: "복사한 HEX를 :root { --color-1: #...; }로 변수화하면 사이트 전체에 일관 적용 가능." }], addedAt: "2026-05-18" },
  { slug: "pomodoro", component: "PomodoroTool", category: "calc", icon: "🍅", navTitle: "포모도로 타이머", title: "포모도로 타이머 - 25/5 집중 사이클 (소리 알림 · 통계)", h1: "🍅 포모도로 타이머", description: "25분 집중 + 5분 휴식 사이클로 작업 효율을 높이는 포모도로 기법 타이머. 4사이클마다 긴 휴식, 소리·브라우저 알림, 사이클 통계 제공. 학습·코딩·글쓰기·시험 공부에 자주 쓰입니다.", metaDescription: "포모도로 타이머 무료. 25/5 사이클, 알림 + 통계, 브라우저 안전.", howTo: ["집중·휴식 시간을 설정합니다 (기본 25/5).", "▶ 시작 버튼을 누릅니다.", "타이머가 끝나면 알림과 함께 자동으로 다음 단계로 넘어갑니다."], faq: [{ q: "포모도로 기법이 뭐예요?", a: "이탈리아 토마토 모양 타이머(pomodoro)에서 이름이 유래. 25분 집중 + 5분 휴식을 한 사이클로 반복해 집중력 + 휴식 균형을 잡는 시간 관리 기법입니다." }, { q: "왜 25분이에요?", a: "사람의 평균 집중력 지속 시간이 약 25~30분이라는 연구를 반영. 짧고 명확한 목표로 시작 부담을 줄입니다. 본인 페이스에 맞게 조절 가능." }, { q: "알림이 안 와요.", a: "브라우저 알림 권한을 허용했는지 확인하세요. 첫 시작 시 자동 권한 요청. 또 탭이 백그라운드에 있어도 사운드는 재생됩니다." }, { q: "탭을 닫으면 멈추나요?", a: "네. 브라우저 기반이라 탭을 닫으면 타이머가 멈춥니다. 모바일은 화면 켜둔 채로 사용하세요." }, { q: "긴 휴식은 언제?", a: "기본 4사이클마다(=2시간 작업 후) 15분 긴 휴식. 회사 점심·산책에 활용." }, { q: "집중이 잘 안 될 때?", a: "환경을 조정하세요 — 알림 끄기, 스마트폰 멀리, 헤드폰 + 백색소음. 25분조차 어렵다면 15/3분부터 시작해 점차 늘려가도 됩니다." }], addedAt: "2026-05-18" },
  { slug: "trip-split", component: "TripSplitTool", category: "calc", icon: "✈️", navTitle: "여행 경비 분할 (더치페이)", title: "여행 경비 분할 계산기 - 누가 누구에게 얼마 송금 (정산)", h1: "여행 경비 분할·정산 (더치페이)", description: "여행·회식·동아리 활동에서 발생한 비용을 멤버별로 나누고 최소 송금 횟수로 정산합니다. 각 비용마다 누가 결제했는지 + 누가 분담하는지 별도 지정 가능 (술 안 마신 사람 제외 등). 그리디 알고리즘으로 송금 횟수를 최소화.", metaDescription: "여행 경비 분할 무료. 더치페이, 다인 정산, 최소 송금, 부분 분담.", howTo: ["참여자 이름을 추가합니다.", "비용 내역마다 금액·결제자·분담자를 설정합니다.", "정산 결과(누가 누구에게 얼마 송금)가 자동 계산됩니다."], faq: [{ q: "단순 N분의 1과 뭐가 달라요?", a: "이 도구는 (1) 각 비용을 누가 결제했는지 추적, (2) 비용별로 분담자를 다르게 지정 가능, (3) 최종 누가 누구에게 얼마를 보내야 하는지 송금 명세까지 만들어줍니다. 그냥 'N분의 1'보다 훨씬 실용적." }, { q: "왜 모두가 모두에게 송금 안 해요?", a: "그리디 알고리즘으로 송금 횟수를 최소화합니다. 예: 5명이 정산해도 2~3번의 송금으로 끝나도록 최적화." }, { q: "술 안 마신 사람은?", a: "각 비용의 '나눠 부담' 체크에서 해당 사람을 빼면 됩니다. 그 비용은 체크된 사람들만 N분의 1로 분담합니다." }, { q: "결과를 카톡으로 보내려면?", a: "정산 결과를 스크린샷 찍거나 텍스트로 복사해 단톡방에 공유하면 됩니다. 도구는 화면 표시까지." }, { q: "데이터가 외부로 가나요?", a: "아니요. 모든 계산이 브라우저 안에서 일어나며 외부 전송 없음. 새로고침하면 데이터가 사라지니 필요하면 미리 캡처해 두세요." }, { q: "환율·외화도 됩니까?", a: "단일 통화 기준입니다. 해외여행이라면 미리 본인 통화로 환산 후 입력하거나, [환율 계산기]를 함께 사용하세요." }], addedAt: "2026-05-18" },
  { slug: "og-card", component: "OgCardMakerTool", category: "image", icon: "📇", navTitle: "OG 카드 메이커", title: "OG 카드 메이커 - 블로그·SNS 공유용 1200×630 이미지", h1: "OG 카드 메이커 (소셜 공유 이미지)", description: "블로그 글 발행 전 SNS 미리보기용 OG 이미지를 빠르게 만듭니다. 제목·부제·태그·색상 프리셋 선택 → 1200×630 PNG. 인스타 정사각·세로, 스토리·릴스, 유튜브 썸네일 크기도 한 도구에서 지원합니다.", metaDescription: "OG 이미지 무료 생성. 1200×630, 블로그·SNS 공유 카드.", howTo: ["제목·부제·태그를 입력합니다.", "색상 프리셋과 크기(OG/인스타/유튜브 등)를 선택합니다.", "PNG로 다운로드합니다."], faq: [{ q: "OG 이미지가 뭐예요?", a: "Open Graph 이미지. 페이스북·트위터·카카오톡 등에서 링크 공유 시 미리보기로 보이는 이미지. 표준 크기는 1200×630px." }, { q: "어디에 쓰는 거예요?", a: "블로그 HTML <meta property=\"og:image\" content=\"...\"> 에 추가. 검색·SNS 공유 시 미리보기 카드로 표시되어 클릭률을 크게 높입니다." }, { q: "왜 1200×630이에요?", a: "페북·트위터 표준 비율. 모바일·데스크톱 모두 잘 보이게 디자인된 크기. 너무 작거나 비율이 다르면 잘리거나 흐릿하게 표시." }, { q: "유튜브 썸네일에도 쓸 수 있나요?", a: "1280×720 크기를 선택하면 됩니다. 다만 유튜브 썸네일은 더 자극적·시각적 요소가 효과적이라 별도 디자인 권장." }, { q: "한글 폰트가 깨져요?", a: "시스템 폰트(Pretendard·맑은 고딕·Apple SD Gothic Neo)를 자동 사용. 사용자 OS에 따라 폰트가 다를 수 있어요." }, { q: "이미지 배경도 넣을 수 있나요?", a: "현재는 단색·그라데이션 배경만 지원. 사진 배경이 필요하면 [이미지에 글자 넣기] 도구를 사용하세요." }], addedAt: "2026-05-18" },
  { slug: "mermaid", component: "MermaidTool", category: "dev", icon: "📊", navTitle: "Mermaid 다이어그램", title: "Mermaid 다이어그램 - 순서도·시퀀스·간트·클래스 텍스트로 그리기", h1: "Mermaid 다이어그램 에디터", description: "텍스트 코드로 순서도(flowchart)·시퀀스 다이어그램·간트차트·클래스 다이어그램·파이차트 등을 그립니다. GitHub README·노션·옵시디언이 이미 mermaid를 지원해서 결과를 바로 임베드 가능. SVG·PNG로 다운로드.", metaDescription: "Mermaid 다이어그램 무료. 텍스트 → 순서도·간트·시퀀스, SVG/PNG.", howTo: ["샘플 중 하나를 선택해 시작합니다.", "왼쪽 코드를 편집하면 오른쪽 미리보기가 실시간 갱신됩니다.", "SVG 또는 PNG로 다운로드합니다."], faq: [{ q: "Mermaid가 뭐예요?", a: "다이어그램을 텍스트로 그리는 오픈소스 도구. 코드처럼 작성하므로 버전 관리·복사·수정이 쉬워 개발자·기술 글에 많이 쓰입니다." }, { q: "GitHub README에 임베드?", a: "GitHub는 2022년부터 마크다운 안의 ```mermaid 코드 블록을 자동 렌더링합니다. 본 도구로 코드 만들고 README에 그대로 붙여넣으면 됩니다." }, { q: "노션·옵시디언에서도?", a: "옵시디언은 코드 블록 그대로 렌더링. 노션은 일부 플러그인 필요. 결과 PNG를 첨부하는 게 가장 호환성 좋음." }, { q: "어떤 다이어그램?", a: "순서도(flowchart), 시퀀스 다이어그램(sequenceDiagram), 간트차트(gantt), 클래스 다이어그램(classDiagram), 상태 다이어그램, ER 다이어그램, 파이차트(pie) 등 10종 이상." }, { q: "PowerPoint·키노트에 쓰려면?", a: "PNG 다운로드 후 슬라이드에 이미지로 삽입. 2배 해상도로 추출하므로 인쇄용으로도 깨끗합니다." }, { q: "복잡한 디자인 가능?", a: "Mermaid는 빠르고 명확한 다이어그램 위주. 자유로운 디자인이 필요하면 draw.io, Figma, Excalidraw가 적합합니다." }], addedAt: "2026-05-18" },
  { slug: "image-batch", component: "ImageBatchTool", category: "image", icon: "🗂️", navTitle: "이미지 일괄 편집기 (통합)", title: "이미지 일괄 편집기 - 압축·리사이즈·포맷 변환 (여러 장 한 번에)", h1: "이미지 일괄 편집기 (통합)", description: "여러 이미지를 한 번에 압축·리사이즈·포맷 변환(JPG/PNG/WebP). ZIP으로 묶어 다운로드. 블로그·쇼핑몰 상품 이미지 일괄 처리, 앨범 백업 용량 절감, 외부 공유 전 일괄 가공에 자주 쓰입니다.", metaDescription: "이미지 일괄 편집 무료. 여러 장 압축·리사이즈·포맷, ZIP 다운로드.", howTo: ["여러 이미지를 선택하거나 드래그합니다.", "최대 가로(px)·화질·출력 포맷을 설정합니다.", "[일괄 변환]을 누르면 모두 처리됩니다.", "각 이미지 개별 다운로드 또는 ZIP으로 모두 다운로드."], faq: [{ q: "몇 장까지?", a: "기술적으로 무제한이지만 브라우저 메모리 한계로 100장·합쳐서 500MB 이내 권장. 그 이상은 데스크톱 도구가 안정적." }, { q: "원본 비율은 유지되나요?", a: "네. 최대 가로(px)만 지정하고 세로는 비율 유지로 자동 계산됩니다. 0으로 두면 원본 크기 유지." }, { q: "투명한 PNG를 JPG로 바꾸면?", a: "JPG는 투명도가 없어 흰색 배경으로 변환됩니다. 투명도 보존이 필요하면 PNG·WebP 출력을 선택하세요." }, { q: "WebP가 가장 효율적인가요?", a: "보통 같은 화질에 JPG 대비 25~35% 작습니다. 현대 브라우저 99% 지원이라 웹 업로드에 추천. 카톡·일부 구버전 앱은 미지원." }, { q: "이미지가 외부로 가나요?", a: "아니요. 모든 처리가 브라우저 Canvas API로 일어나며 어디로도 전송되지 않습니다. 영수증·인사 자료 등 민감 이미지도 안전." }, { q: "단일 이미지면?", a: "[이미지 압축], [이미지 크기 변경], [PNG → JPG] 등 개별 도구가 UI가 더 단순합니다. 여러 장 일괄이 필요할 때 이 도구가 효율적." }], addedAt: "2026-05-18" },

  { slug: "video-editor", component: "VideoEditorTool", category: "video", icon: "🎬", navTitle: "동영상 편집기 (통합)", title: "동영상 편집기 - 자르기 · 회전 · 속도 · 무음 · 해상도 · 압축 (한 번에)", h1: "동영상 편집기 (통합)", description: "자르기·회전·반전·속도 변경·무음 처리·해상도 변경·압축을 한 도구에서 한 번에 적용합니다. 여러 편집을 동시에 처리해 ffmpeg 실행 횟수를 줄이고 화질 손실도 최소화. 단일 작업이라면 카테고리의 개별 도구도 그대로 사용 가능합니다.", metaDescription: "동영상 편집기 무료. 자르기·회전·속도·무음·해상도·압축 한 번에, ffmpeg.wasm.", howTo: ["동영상 파일을 업로드합니다 (드래그 가능).", "원하는 편집(자르기·회전·속도·해상도·무음·압축)을 선택합니다.", "편집 적용 & 변환 버튼을 누릅니다.", "결과 미리보기 후 MP4로 다운로드합니다."], faq: [{ q: "이 도구로 가능한 작업?", a: "자르기, 회전(90·180·270·좌우/상하 반전), 속도 변경(0.25~3배), 무음 처리, 해상도 변경(240p~1080p), 압축(CRF 18~33) — 여러 작업 동시 적용 가능." }, { q: "여러 작업을 동시에 하면 화질이 더 떨어지지 않나요?", a: "오히려 좋습니다. 개별 도구로 여러 번 변환하면 매번 재인코딩되지만, 이 통합 도구는 한 번의 ffmpeg 실행으로 모든 처리를 끝내 손실이 최소화됩니다." }, { q: "단일 작업만 필요하면?", a: "[동영상 자르기], [동영상 회전], [동영상 압축] 등 개별 도구가 그대로 남아 있습니다. UI가 더 간단해 빠르게 작업 가능." }, { q: "변환·합치기·GIF 같은 작업도?", a: "이 도구는 단일 영상의 편집 위주입니다. 변환(MP3·GIF), 합치기, 정보 보기는 카테고리의 [동영상 → MP3], [동영상 합치기], [동영상 정보] 같은 전용 도구를 사용하세요." }, { q: "처리에 얼마나 걸리나요?", a: "재인코딩이 필요한 작업(자르기 외 모두)이 있으면 영상 길이의 1~2배. 자르기만 단독이면 스트림 복사 방식으로 매우 빠릅니다." }, { q: "왜 ffmpeg.wasm 첫 다운로드가 느려요?", a: "첫 실행 시 ffmpeg.wasm 코어(~25MB)를 다운로드합니다. 이후엔 브라우저 캐시되어 즉시 실행됩니다. 모든 처리는 브라우저 안에서 일어나며 영상이 외부로 전송되지 않습니다." }], addedAt: "2026-05-18" },

  { slug: "hanja-dict", component: "HanjaDictTool", category: "text", icon: "漢", navTitle: "한자 사전 (음·뜻·획수)", title: "한자 사전 - 음 · 뜻 · 획수 · 한자능력검정 급수", h1: "한자 사전 (음 · 뜻 · 획수)", description: "자주 쓰는 한자 약 170자의 음·훈·획수·한자검정시험 급수를 검색합니다. 한자 학습, 한자 시험 준비, 이름·신문 한자 의미 확인, 자녀 한자 공부 보조에 자주 쓰입니다.", metaDescription: "한자 사전 무료. 한자 음·뜻·획수·급수, 한자능력검정 8~3급.", howTo: ["한자, 음(예: 산), 뜻(예: 메), 급수(예: 8급) 어느 것으로든 검색합니다.", "한자를 클릭하면 상세 정보가 표시됩니다.", "복사 버튼으로 한자 자체를 클립보드에 담을 수 있습니다."], faq: [{ q: "몇 자 수록되어 있나요?", a: "현재 한국어문회 한자능력검정시험 8~3급 위주 약 170자. 추가 한자는 점진적으로 확장 예정입니다." }, { q: "본문에 한자가 섞인 글을 일괄 음 변환?", a: "[한자 → 한글] 변환 도구를 사용하세요. 600자 사전 기반으로 본문 일괄 변환에 적합합니다." }, { q: "급수가 뭐예요?", a: "한국어문회 한자능력검정시험 등급. 8급(50자)이 가장 쉽고 1급(3500자)이 가장 어려움. 4급 정도면 신문 기사 한자 대부분 읽기 가능." }, { q: "약자·이체자는?", a: "정자체 위주로 수록. 약자가 흔한 한자(국·국·국 등)도 일부 포함하지만 전 약자 매핑은 별도 사전 필요." }, { q: "획수가 학교 표기와 달라요. 왜?", a: "획수 셈법은 정자체 표준 + 한국·중국·일본 표기 차이로 ±1 정도 다를 수 있습니다. 한자능력검정 표준을 따랐습니다." }, { q: "한자 부수 검색은요?", a: "현재 미지원. 부수 검색이 필요하면 네이버 한자사전 같은 전문 사이트를 추천합니다." }], addedAt: "2026-05-18" },

  { slug: "pdf-unlock", component: "PdfUnlockTool", category: "pdf", icon: "🔓", navTitle: "PDF 암호 해제", title: "PDF 암호 해제 - 잠긴 PDF 열기 (본인 소유 파일)", h1: "PDF 암호 해제", description: "잠긴 PDF의 암호를 해제합니다. 본인이 소유하거나 정당하게 접근 권한이 있는 PDF에 한해 사용. 편집·인쇄·복사 권한만 제한된 PDF는 우회 가능하지만 강력한 열기 암호는 정확한 비밀번호가 필요합니다.", metaDescription: "PDF 암호 해제 무료. 잠긴 PDF 열기, pdf-lib 기반, 브라우저 내 처리.", howTo: ["잠긴 PDF 파일을 업로드합니다.", "암호를 알면 입력하고, 모르면 비워둔 채 시도합니다.", "해제 시도 버튼을 누릅니다.", "성공하면 잠금 해제된 PDF를 다운로드합니다."], faq: [{ q: "암호 없이 해제할 수 있나요?", a: "편집·인쇄·복사 권한만 걸린 PDF(소유자 암호)는 우회 가능할 수 있지만, 열기 자체를 막는 사용자 암호는 본래 비밀번호가 있어야 합니다." }, { q: "암호 무차별 대입(크래킹)도 가능?", a: "이 도구는 크래킹 기능을 제공하지 않습니다. 본인 소유 파일의 정당한 잠금 해제 용도입니다." }, { q: "AES-256 강력 암호화도?", a: "표준 라이브러리(pdf-lib) 한계로 일부 강력한 암호화는 처리가 안 될 수 있습니다. 한컴오피스·Adobe Acrobat의 정식 해제 기능을 사용하세요." }, { q: "법적으로 문제 없나요?", a: "본인 소유·정당한 권한이 있는 파일만 처리하세요. 타인의 PDF를 무단 해제하는 행위는 저작권법·정보통신망법 위반 소지가 있어 책임은 사용자에게 있습니다." }, { q: "처리 후 원본은?", a: "원본 파일은 그대로 유지되며 새로 해제된 사본만 다운로드됩니다." }, { q: "처리가 외부로?", a: "모든 처리가 브라우저 안에서 일어나며 PDF와 암호 모두 외부 서버로 전송되지 않습니다." }], addedAt: "2026-05-18" },
  ...
  },
  {
    ...
    icon: "🗜️",
    navTitle: "PDF 압축",
    title: "PDF 압축 - 무료 PDF 용량 줄이기 (가입 불필요)",
    h1: "PDF 용량 줄이기",
    description:
    ...
    metaDescription:
      "PDF 용량 무료 압축. 스캔본·사진 PDF에 특히 효과적, 화질 선택 가능, 브라우저 안전 처리.",
    howTo: [
      "PDF 파일을 업로드합니다.",
  ...
  },
  {
    ...
    faq: [
      { q: "여러 장을 한 번에 변환할 수 있나요?", a: "네. 사진을 여러 장 한꺼번에 넣으면 순서대로 변환되고, 각각 내려받거나 ZIP으로 한 번에 받을 수 있습니다. 아이폰에서 수십 장을 골라 한 번에 올려도 됩니다." },
  ...
  // ===== Batch G - text =====
  { slug: "text-reverse", component: "TextReverseTool", category: "text", icon: "↩️", navTitle: "텍스트 거꾸로", title: "텍스트 거꾸로 - 글자 · 단어 · 줄 단위 역순 변환", h1: "텍스트 거꾸로 만들기", description: "글자, 단어, 줄 단위로 텍스트를 역순으로 뒤집습니다. 카톡·SNS 재미용 짤, 데이터 정렬 뒤집기, 학습용 텍스트 처리, 거울 효과 디자인에 자주 쓰입니다.", metaDescription: "텍스트 거꾸로 무료. 글자·단어·줄 역순.", howTo: ["텍스트를 입력합니다.", "모드(글자/단어/줄)를 선택합니다.", "복사합니다."], faq: [{ q: "한글도 되나요?", a: "네. 한글 음절 단위로 역순됩니다. '안녕하세요' → '요세하녕안'." }, { q: "이모지·특수문자는?", a: "유니코드 처리되어 정상 역순됩니다. 다만 일부 결합 이모지(👨‍👩‍👧)는 분리될 수 있어요." }, { q: "글자/단어/줄 단위 차이?", a: "글자: '안녕' → '녕안'. 단어: '안녕 세상' → '세상 안녕'. 줄: '1줄\\n2줄' → '2줄\\n1줄'." }, { q: "엑셀 데이터 뒤집기에 좋아요?", a: "엑셀에서 데이터를 거꾸로 정렬하고 싶을 때 '줄 단위 역순'을 쓰면 한 번에 처리됩니다." }, { q: "거울 글자(좌우 반전)도 됩니까?", a: "이 도구는 순서만 뒤집습니다. 글자 자체를 좌우 반전한 모양(역상)은 이미지 처리 도구가 필요합니다." }], addedAt: "2026-05-14" },
  { slug: "line-numbers", component: "LineNumbersTool", category: "text", icon: "1️⃣", navTitle: "줄 번호 추가", title: "텍스트 줄 번호 추가 - 자동 번호 매기기 (커스텀 시작 · 구분자)", h1: "줄 번호 추가", description: "여러 줄 텍스트에 자동으로 줄 번호를 매깁니다. 시작 번호·구분자·자릿수 패딩 설정 가능. 코드 인용, 회의록 항목 번호, 명단 정리, 강의 노트 정렬, 인쇄용 자료에 자주 쓰입니다.", metaDescription: "줄 번호 추가 무료. 시작 번호·구분자 조절, 일괄 처리.", howTo: ["텍스트를 입력합니다.", "옵션을 조절하면 즉시 반영됩니다.", "복사해서 활용하세요."], faq: [{ q: "0부터 시작도 되나요?", a: "시작 번호를 자유롭게 입력할 수 있습니다. 음수도 입력 가능." }, { q: "구분자는 뭘 쓸 수 있나요?", a: "점(.), 콜론(:), 괄호 등 자유롭게 입력 가능. 예: '1. 항목', '1) 항목', '[1] 항목'." }, { q: "자릿수 패딩이 뭐예요?", a: "1·2·3 대신 01·02·03 처럼 자릿수를 맞춰 표시. 정렬 시 보기 좋습니다." }, { q: "빈 줄도 번호가 매겨지나요?", a: "옵션으로 빈 줄을 건너뛰거나 포함하도록 선택할 수 있습니다." }, { q: "역순 번호는?", a: "현재는 순방향 번호만 지원합니다. 역순이 필요하면 [텍스트 거꾸로]로 줄 순서를 뒤집고 번호 매기세요." }, { q: "엑셀 행 번호 만들기에 좋아요?", a: "엑셀에서 ROW() 함수가 더 편할 수 있지만, 외부 데이터에 빠르게 번호 매길 때 이 도구가 빠릅니다." }], addedAt: "2026-05-14" },
  { slug: "reading-time", component: "ReadingTimeTool", category: "text", icon: "⏰", navTitle: "발표·읽기 시간", title: "발표 시간 / 읽기 시간 추정 - 글자수 → 분 (WPM)", h1: "발표 / 읽기 시간 추정", description: "텍스트 글자수로 발표 시간(WPM)과 묵독 시간을 추정합니다. 한국어·영어 분당 속도 조절 가능. 프레젠테이션 시간 맞추기, 강의·발표 원고 준비, 블로그 글 'X분 읽기' 표시, 오디오북 길이 예측에 자주 쓰입니다.", metaDescription: "발표 시간 추정 무료. WPM 기반, 한국어·영어 지원.", howTo: ["원고를 붙여넣습니다.", "분당 단어/글자 수를 조절합니다.", "발표·묵독 시간이 자동 계산됩니다."], faq: [{ q: "기본 속도는?", a: "한국어 발표 평균 분당 300자, 묵독 분당 500자입니다. 영어는 발표 130WPM, 묵독 250WPM." }, { q: "발표 시간이 안 맞아요. 왜?", a: "사람마다·내용 난이도마다 다릅니다. 익숙한 주제는 빠르고 복잡한 슬라이드 설명은 느려져요. 본인 평소 속도를 측정해 보세요." }, { q: "5분 발표는 몇 자가 적당?", a: "한국어 약 1,500자(약 A4 1.5장). 슬라이드 전환·질문 시간 빼고 본 발표 기준." }, { q: "블로그에 'X분 읽기' 표시 어떻게 정해요?", a: "묵독 평균(분당 500자) 기준. 본 도구 결과를 그대로 활용 가능. Medium은 영문 270WPM 기준." }, { q: "급해서 빨리 말하면?", a: "원고 그대로 분당 350~400자까지 가능하지만 청중 이해도가 떨어집니다. 적정 속도가 더 중요." }, { q: "오디오북 녹음 시간 예측?", a: "묵독보다 50~70% 느립니다. 본 도구의 발표 시간 + 호흡·강조 시간 합치면 비슷합니다." }], addedAt: "2026-05-14" },
  { slug: "hanja-to-hangul", component: "HanjaToHangulTool", category: "text", icon: "漢", navTitle: "한자 → 한글", title: "한자 한글 변환 - 자주 쓰는 한자 600자 음 변환", h1: "한자 → 한글 변환", description: "자주 쓰는 한자 600자를 한글 음으로 변환합니다. 신문·잡지에 나온 한자 읽기, 한자가 포함된 이름 음 확인, 옛 문서·계약서 한자 해독, 한자 자격증 학습에 유용합니다.", metaDescription: "한자 한글 변환 무료. 자주 쓰는 한자 600자, 빠른 검색.", howTo: ["한자가 포함된 텍스트를 입력합니다.", "한글 변환 결과가 표시됩니다.", "복사해서 활용하세요."], faq: [{ q: "모든 한자가 되나요?", a: "자주 쓰는 600자 사전 기반입니다. 누락된 한자는 그대로 둡니다. 흔히 쓰는 한자는 대부분 포함됩니다." }, { q: "한 한자가 여러 음을 가질 때?", a: "가장 흔히 쓰이는 음 하나를 우선 표시합니다. 문맥에 따라 정확한 음이 필요하면 사전을 참고하세요. 예: '樂'은 '락(즐거움)' 또는 '악(음악)'." }, { q: "이름 한자 음 변환에 좋아요?", a: "네. '金哲秀' → '김철수' 식으로 빠르게 음을 알 수 있습니다. 단 인명에 흔한 한자가 누락될 수 있어 사전 검색 권장." }, { q: "한국식 vs 중국식 음?", a: "한국식 음만 표시합니다. 중국어 핀음(pinyin)은 별도 도구가 필요합니다." }, { q: "왜 600자만?", a: "한국에서 일상적으로 쓰이는 한자가 대략 1,800자, 가장 흔한 600자만 우선 포함했습니다. 더 많은 한자는 후속 업데이트 예정." }, { q: "한자 검정 시험 준비에도 좋아요?", a: "한자능력검정시험 8~5급 수준 한자가 대부분 포함됩니다. 4급 이상은 추가 사전이 필요합니다." }], addedAt: "2026-05-14" },
  ...
  { slug: "qr-logo", component: "QrLogoTool", category: "qr", icon: "🖼️", navTitle: "로고 있는 QR", title: "로고 들어간 QR 코드 - 중앙에 이미지 삽입 (브랜드 QR)", h1: "로고 들어간 QR 코드", description: "QR 코드 중앙에 로고/아이콘을 삽입하세요. 브랜드 QR에 유용. 오류 정정 레벨 자동 설정. 카페·매장 로고 QR, 명함 QR, 행사 안내 포스터, 회사 브로슈어, 결혼식 청첩장 QR에 자주 쓰입니다.", metaDescription: "로고 QR 무료 생성. 중앙 이미지 삽입, 브랜드 QR.", howTo: ["URL/텍스트를 입력합니다.", "로고 이미지를 업로드합니다.", "크기·배경 옵션을 조정합니다.", "PNG로 다운로드합니다."], faq: [{ q: "스캔이 잘 되나요?", a: "오류 정정 레벨 H를 사용해 로고 영역(중앙 25%까지)을 가려도 스캔 가능합니다. 다만 너무 크게 가리면 인식이 어려울 수 있어요." }, { q: "어떤 이미지가 잘 어울려요?", a: "정사각형·단순한 디자인의 로고가 좋습니다. 복잡한 사진은 스캔 방해. PNG(투명 배경)가 가장 깔끔합니다." }, { q: "로고 크기는 어느 정도?", a: "QR 전체의 15~25% 이내가 안전합니다. 그 이상이면 위치 패턴(모서리 사각형)을 침범해 인식 실패 가능." }, { q: "스캔 테스트는 어떻게?", a: "다운로드 후 다른 폰 카메라로 직접 스캔해 보세요. iOS·Android 기본 카메라 모두 테스트 권장." }, { q: "글자를 가운데에 넣고 싶다면?", a: "[텍스트 있는 QR] 도구를 사용하세요. 가게 이름·행사명 등 글자를 직접 넣을 수 있습니다." }, { q: "인쇄용 고해상도?", a: "PNG 다운로드 시 크기를 800~1200px로 설정하면 A4 인쇄에도 깨끗합니다." }], addedAt: "2026-05-14" },
  { slug: "qr-text", component: "QrTextTool", category: "qr", icon: "🆎", navTitle: "텍스트 있는 QR", title: "텍스트 들어간 QR 코드 - 중앙에 글자 삽입 (가게명·행사명)", h1: "텍스트 들어간 QR 코드", description: "QR 코드 중앙에 가게 이름·이름·행사명·로고 텍스트 등 글자를 삽입합니다. 색상·배경 모양 자유 설정. 로고 이미지 대신 글자로 표현, 매장 안내, 명함, 이벤트 포스터, 와이파이 QR 위에 와이파이 이름 표시 등에 유용합니다.", metaDescription: "텍스트 QR 무료 생성. 중앙 글자 삽입, 배경 모양·색상 선택.", howTo: ["QR에 담을 URL/텍스트를 입력합니다.", "중앙에 표시할 글자를 입력합니다.", "글자 크기·색·배경 모양을 조절합니다.", "PNG로 다운로드합니다."], faq: [{ q: "스캔이 잘 되나요?", a: "오류 정정 레벨 H로 생성되어 중앙 영역(약 25%까지)을 글자로 가려도 스캔이 가능합니다. 너무 크게 가리면 인식이 어려울 수 있어요." }, { q: "한글도 되나요?", a: "한글·영어·이모지 모두 가능합니다. 시스템 폰트로 렌더링됩니다." }, { q: "[로고 있는 QR]과 차이?", a: "로고는 이미지 파일 필요, 텍스트는 입력만 하면 됩니다. 간단한 가게명·이름 표시는 텍스트가 더 편해요." }, { q: "배경 모양은 어떤 게 있어요?", a: "사각형, 둥근 사각형, 원형 등 다양한 모양을 지원합니다. 디자인 콘셉트에 맞춰 선택." }, { q: "글자 색깔을 어둡게 하면?", a: "글자 영역은 그대로 인식이 가능하지만, QR 본체 색과 너무 비슷하면 시각적으로 헷갈리니 대비를 주세요." }, { q: "여러 줄 텍스트도 됩니까?", a: "긴 텍스트보다 1~2단어가 적합합니다. 너무 길면 글자가 작아져 시인성이 떨어집니다." }], addedAt: "2026-05-16" },

  // ===== Batch H - academic / 논문·인용 =====
  { slug: "cite-format", component: "CiteFormatTool", category: "academic", icon: "📑", navTitle: "인용 형식 변환기", title: "인용 형식 변환기 - APA·MLA·Chicago·Harvard·IEEE 5종 동시", h1: "인용 형식 변환기 (APA·MLA·Chicago·Harvard·IEEE)", description: "저자·연도·제목·저널 등을 입력하면 APA 7판, MLA 9판, Chicago, Harvard, IEEE 5가지 형식의 참고문헌 항목을 동시에 생성합니다. 학술지·단행본·웹사이트 지원. 논문 작성, 학위논문 참고문헌 정리, 학회 제출용 인용 형식 변환에 자주 쓰입니다.", metaDescription: "참고문헌 형식 변환 무료. APA, MLA, Chicago, Harvard, IEEE 5종 동시 생성.", howTo: ["자료 유형(학술지·단행본·웹사이트)을 선택합니다.", "저자·연도·제목 등 정보를 입력합니다.", "5종 형식이 자동 생성되며 원하는 것을 복사합니다."], faq: [{ q: "어떤 형식을 지원하나요?", a: "APA 7판(심리·교육·사회), MLA 9판(인문학·언어), Chicago(역사·인문), Harvard(영국·호주 다수), IEEE(공학) 등 가장 널리 쓰이는 5가지." }, { q: "이탤릭 처리는?", a: "저널명·서명은 별표(*)로 표시되며, 워드/한글에 붙여넣은 뒤 이탤릭으로 변환해주세요." }, { q: "어떤 분야는 어떤 형식?", a: "심리·교육·간호: APA. 영문학·언어학: MLA. 역사·종교: Chicago. 공학·컴퓨터: IEEE. 사회과학 일부: Harvard." }, { q: "DOI는 어떻게 입력?", a: "DOI 칸에 '10.1234/abc' 형식으로 입력하면 'https://doi.org/...' 자동 추가됩니다." }, { q: "한국 학회 양식은요?", a: "한국심리학회·교육학회 같은 한국 표준은 [한국 학회지 인용] 도구를 사용하세요." }, { q: "DOI나 ISBN만 알면 자동 인용 가능?", a: "[DOI·ISBN 자동 조회] 도구로 메타데이터를 자동으로 가져올 수 있습니다." }], addedAt: "2026-05-16" },
  { slug: "doi-lookup", component: "DoiLookupTool", category: "academic", icon: "🔍", navTitle: "DOI·ISBN 자동 조회", title: "DOI / ISBN → 참고문헌 자동 생성 (CrossRef · Open Library)", h1: "DOI · ISBN 자동 참고문헌 조회", description: "DOI 또는 ISBN을 입력하면 CrossRef·Open Library API로 메타데이터를 자동 조회해 APA·MLA·Chicago 형식의 참고문헌을 만듭니다. 논문 작성 시 한 번에 정확한 참고문헌 자동 생성, 인용 오타 방지에 매우 유용.", metaDescription: "DOI ISBN 자동 인용 무료. CrossRef Open Library 메타데이터 조회.", howTo: ["DOI(예: 10.1038/nature12373) 또는 ISBN(예: 9780262033848)을 입력합니다.", "조회 버튼을 누르면 자동으로 메타데이터를 가져옵니다.", "APA·MLA·Chicago 형식 중 복사합니다."], faq: [{ q: "어떤 데이터베이스를 쓰나요?", a: "DOI는 CrossRef(api.crossref.org), ISBN은 Open Library(openlibrary.org)의 공개 API를 직접 호출합니다." }, { q: "한국 학술지도 되나요?", a: "DOI가 CrossRef에 등록되어 있다면 가능합니다. KCI 등재 학술지는 대부분 등록되어 있어요." }, { q: "DOI는 어디서 찾아요?", a: "논문 PDF 첫 페이지·저널 사이트·Google Scholar 결과에 보통 'doi.org/10.xxxx/...' 형식으로 표시됩니다." }, { q: "ISBN은 어디서?", a: "책 뒤표지 바코드 위, 또는 알라딘·교보문고·아마존에 검색하면 표시됩니다. 10자리 또는 13자리." }, { q: "조회가 실패해요. 왜?", a: "(1) DOI/ISBN 오타, (2) CrossRef에 등록 안 된 학술지(주로 한국 비KCI 학술지), (3) 사라진 ISBN. 직접 [인용 형식 변환기]로 수동 입력하세요." }, { q: "조회 시 외부 서버에 정보 전송되나요?", a: "DOI/ISBN 자체만 CrossRef/Open Library API로 전송됩니다. 그 외 개인정보는 전송되지 않습니다." }], addedAt: "2026-05-16" },
  { slug: "bibtex-convert", component: "BibtexConvertTool", category: "academic", icon: "📚", navTitle: "BibTeX 변환", title: "BibTeX → APA · MLA · Chicago 변환 (LaTeX → 워드)", h1: "BibTeX 참고문헌 변환기", description: "LaTeX의 BibTeX 항목을 일반 텍스트(APA·MLA·Chicago) 참고문헌으로 변환합니다. 워드·한글로 논문 옮길 때, Zotero·Mendeley에서 내보낸 BibTeX 정리, 학회별 다른 형식 요구 대응에 유용합니다.", metaDescription: "BibTeX 변환 무료. APA MLA Chicago 텍스트 변환, 여러 항목 한번에.", howTo: ["@article, @book 등 BibTeX 항목을 붙여넣습니다.", "원하는 인용 스타일을 선택합니다.", "변환 결과를 복사해 문서에 붙여넣습니다."], faq: [{ q: "여러 항목을 한 번에?", a: "예. 여러 @entry를 한 번에 붙여넣어도 모두 변환됩니다." }, { q: "지원하는 항목 유형?", a: "@article(학술지), @book(단행본), @inproceedings(컨퍼런스), @incollection(편저), @misc(기타) 등 주요 BibTeX 유형을 지원합니다." }, { q: "Zotero·Mendeley에서 가져온 BibTeX도?", a: "네. 대부분의 참고문헌 관리 도구가 표준 BibTeX 형식으로 내보내므로 그대로 사용 가능합니다." }, { q: "특수 문자가 깨져요. 왜?", a: "BibTeX 특수 문자(\\\"o, ñ, é)는 자동 변환됩니다. 일부 한자·한글 특수 문자는 그대로 두는 게 안전." }, { q: "키 정렬을 알파벳 순으로?", a: "여러 항목 변환 후 [참고문헌 정렬·중복제거] 도구로 알파벳·가나다 순 정렬이 가능합니다." }, { q: "한국 학회 양식이 필요해요.", a: "[한국 학회지 인용] 도구 사용. BibTeX은 영문 학술 표준 위주라 한국 양식은 직접 변환 필요." }], addedAt: "2026-05-16" },
  { slug: "bib-sort", component: "BibSortTool", category: "academic", icon: "🔤", navTitle: "참고문헌 정렬·중복제거", title: "참고문헌 가나다 · 알파벳 정렬 + 중복 제거 (Hanging indent)", h1: "참고문헌 정렬 / 중복 제거 / Hanging indent", description: "참고문헌 목록을 가나다·알파벳 순으로 정렬하고 중복 항목을 제거합니다. Hanging indent 미리보기 제공. 논문 제출 직전 마무리, 여러 사람이 작성한 참고문헌 통합, 인용 정리에 자주 쓰입니다.", metaDescription: "참고문헌 정렬 무료. 가나다 알파벳, 중복 제거, hanging indent.", howTo: ["참고문헌 항목들을 빈 줄로 구분해 붙여넣습니다.", "정렬 순서와 중복 제거 옵션을 선택합니다.", "결과를 복사해 워드/한글에 붙여넣습니다."], faq: [{ q: "한글과 영문 섞여 있어도 되나요?", a: "예. Intl.Collator로 자연 정렬되어 한글은 가나다, 영문은 알파벳 순으로 처리됩니다." }, { q: "Hanging indent란?", a: "참고문헌 목록에서 첫 줄은 그대로 두고 두 번째 줄부터 들여쓰는 방식입니다. APA·MLA 표준 스타일이라 학술 논문에 필수." }, { q: "워드에서 hanging indent 어떻게 적용?", a: "단락 → 들여쓰기 → 특수 → '내어쓰기'(영어판: Hanging) 선택. 본 도구는 미리보기만 제공." }, { q: "중복은 어떻게 판별?", a: "텍스트가 정확히 같은 항목을 중복으로 봅니다. 띄어쓰기·구두점이 미세하게 다르면 다른 항목으로 인식되니 정리 후 시도." }, { q: "저자명 알파벳 순? 출판연도 순?", a: "기본은 첫 글자 알파벳·가나다 순입니다. APA·MLA 표준은 저자명 알파벳 순." }, { q: "100개 이상 참고문헌도 됩니까?", a: "수백 개도 즉시 처리됩니다. 학위논문 수준의 긴 목록도 무리 없이 정렬 가능합니다." }], addedAt: "2026-05-16" },
  { slug: "title-case", component: "TitleCaseTool", category: "academic", icon: "🅰️", navTitle: "영문 제목 대문자화", title: "영문 제목 Title Case 변환 - APA · Chicago · MLA 규칙", h1: "영문 제목 Title Case 변환", description: "영문 논문·에세이 제목을 APA, Chicago, MLA 규칙에 맞춰 자동으로 대문자화합니다. 짧은 전치사·접속사는 소문자 유지. 영문 논문 제목, 영문 발표 자료, 영어 책 표지 디자인, 영문 이력서에 자주 쓰입니다.", metaDescription: "Title Case 변환 무료. APA Chicago MLA 규칙, 영문 논문 제목 대문자화.", howTo: ["영문 제목을 입력합니다.", "APA·Chicago·MLA 등 다양한 결과를 비교합니다.", "원하는 스타일을 복사합니다."], faq: [{ q: "APA와 Chicago 차이는?", a: "APA는 4자 이상 단어를 대문자, Chicago는 모든 주요 단어를 대문자로 처리합니다. 짧은 전치사·접속사·관사는 둘 다 소문자 유지." }, { q: "왜 작은 단어들은 소문자?", a: "a, an, the, and, or, but, in, on, at, to, of, with 같은 관사·접속사·짧은 전치사는 대문자에서 제외됩니다 (영문 출판 관행)." }, { q: "첫 단어와 마지막 단어?", a: "위치 상관없이 항상 대문자. 'The Of A Book' 같은 식으로 짧은 단어라도 첫·마지막은 대문자." }, { q: "콜론 뒤 단어는?", a: "콜론(:) 뒤 첫 단어도 대문자입니다. 'A Study: Methods and Results'." }, { q: "하이픈 단어는 어떻게?", a: "보통 'Self-Esteem'처럼 양쪽 다 대문자. 일부 스타일은 'Self-esteem'으로 두 번째 부분만 소문자." }, { q: "다른 종류의 변환은?", a: "단순 대소문자 변환만 필요하면 [대소문자 변환]에서 UPPER·lower·camelCase 등을 사용하세요." }], addedAt: "2026-05-16" },
  { slug: "korean-cite", component: "KoreanCiteTool", category: "academic", icon: "📚", navTitle: "한국 학회지 인용", title: "한국 학회지 인용 양식 - KPA · KERA · KSS · 국문 인문계", h1: "한국 학회지 인용 양식 (KPA · KERA · KSS · 국문 인문계)", description: "한국심리학회·교육학회·사회학회·국문 인문계 등 한국 학술 학회별 참고문헌 및 본문 인용 양식을 자동 생성합니다. 학위논문 작성, 한국 학술지 투고, KCI 등재 학술지 양식 맞추기에 자주 쓰입니다.", metaDescription: "한국 학회 인용 무료. 한국심리학회 KPA 한국교육학회 한국사회학회 양식.", howTo: ["원하는 학회 양식을 선택합니다.", "저자·연도·제목·학술지 등을 입력합니다.", "참고문헌과 본문 내 인용을 함께 복사합니다."], faq: [{ q: "어떤 학회를 지원하나요?", a: "한국심리학회(KPA), 한국교육학회(KERA), 한국사회학회(KSS), 그리고 일반 국문 인문계 표준 양식을 지원합니다." }, { q: "KPA와 APA 차이?", a: "한국심리학회는 APA를 기반으로 한국어로 번안했습니다. 저자 표기 방식과 일부 구두점이 다릅니다. 예: APA는 'Smith, J. (2024)', KPA는 '김철수 (2024)'." }, { q: "내가 투고할 학회 양식이 없어요. 어떻게?", a: "도구의 가장 비슷한 양식을 선택해 변환 후 학회 공식 가이드에 맞춰 수동 조정. 양식이 매우 다르면 학회 사이트의 'Manuscript Guidelines'를 직접 참고하세요." }, { q: "본문 내 인용은 어떻게?", a: "직접 인용 '(저자, 연도, p. 페이지)', 간접 인용 '(저자, 연도)'. 도구가 자동으로 형식 만들어줍니다." }, { q: "공동저자가 여러 명이면?", a: "2인: '김철수와 이영희(2024)'. 3인 이상: 첫 번째 인용은 모두, 이후는 '김철수 등(2024)' 또는 '김철수 외(2024)'." }, { q: "영문 논문 인용을 한국 양식에 맞추려면?", a: "한국식 학회는 '저자명(영문)·연도·제목·저널' 순으로 표기. 영문 저자명 그대로 입력하고 변환하면 됩니다." }], addedAt: "2026-05-17" },
  { slug: "text-normalize", component: "TextNormalizeTool", category: "academic", icon: "🧹", navTitle: "표절검사 텍스트 정규화", title: "표절검사 전 텍스트 정규화 - 따옴표 · 공백 · 유니코드 통일", h1: "표절검사 텍스트 정규화", description: "카피킬러·턴잇인 검사 전에 따옴표·공백·줄바꿈·유니코드를 통일합니다. 텍스트 차이로 인한 오탐을 줄여줍니다. 학위논문·과제·논문 제출 전 자가 점검, 인용 정확도 확인에 유용합니다.", metaDescription: "표절검사 텍스트 정규화 무료. 따옴표 공백 유니코드 통일, 카피킬러 사전 처리.", howTo: ["원본 텍스트를 붙여넣습니다.", "정규화 옵션을 선택합니다.", "결과를 복사해 검사기에 넣습니다."], faq: [{ q: "왜 필요한가요?", a: "“ ” ‘ ’ 같은 둥근 따옴표와 \" ' 곧은 따옴표는 표절검사에서 다른 문자로 인식될 수 있습니다. 정규화 후 검사하면 정확도가 올라갑니다." }, { q: "NFC가 뭔가요?", a: "유니코드 정규화 형식 C. 한글의 조합형('ㄱ'+'ㅏ')을 완성형('가')으로 통일합니다." }, { q: "표절검사 점수가 정말 달라지나요?", a: "원본과 인용 텍스트의 따옴표 형식이 다르면 같은 문장이어도 표절검사에서 다르게 인식. 정규화로 더 정확한 비교가 가능합니다." }, { q: "카피킬러·턴잇인 사전 처리에 적합?", a: "네. 둘 다 정규화된 텍스트를 더 정확하게 비교합니다. 도구 사용 전 처리 권장." }, { q: "원본을 그대로 보존하면서?", a: "변환된 결과를 검사기에 넣고, 제출용 원본은 따로 보관하세요. 둘은 다른 목적입니다." }, { q: "어떤 옵션이 가장 중요?", a: "(1) 따옴표 통일 (“ ↔ \"), (2) 다중 공백 단일화, (3) NFC 정규화. 이 셋이 표절검사 정확도에 가장 영향이 큽니다." }], addedAt: "2026-05-17" },
  { slug: "footnote-format", component: "FootnoteFormatTool", category: "academic", icon: "📝", navTitle: "각주 포맷터", title: "각주 / 미주 포맷터 - Chicago · 국문 인문계 (ibid. 재인용)", h1: "각주 / 미주 형식 변환", description: "Chicago Full Note, Chicago Short Note, 국문 인문계 등 다양한 각주 양식을 자동 생성합니다. ibid. 재인용도 함께 제공. 인문학·역사·종교학 논문 작성, 학위논문 각주 정리, 학술서 출판 준비에 자주 쓰입니다.", metaDescription: "각주 미주 포맷 무료. Chicago 국문 인문계 양식, ibid 재인용.", howTo: ["양식과 자료 유형(단행본·학술지·웹)을 선택합니다.", "저자·제목·페이지 등을 입력합니다.", "각주와 재인용 형식을 복사합니다."], faq: [{ q: "ibid. 사용법?", a: "바로 직전 각주와 같은 출처를 가리킬 때 'ibid., 페이지'로 표기합니다. 한국 논문에서는 '위의 책'·'앞의 글'을 씁니다." }, { q: "각주 vs 미주 차이?", a: "각주(footnote)는 페이지 하단에, 미주(endnote)는 챕터·책 끝에 모입니다. 형식은 같고 위치만 다릅니다." }, { q: "왜 인문학은 각주를?", a: "역사·문학·철학 같은 인문학은 본문 흐름을 깨지 않고 상세 출처·부연 설명이 필요해서 각주를 선호합니다. 사회·자연과학은 본문 내 인용이 일반적." }, { q: "Full Note vs Short Note?", a: "처음 인용은 Full Note(전체 정보), 재인용 시 Short Note(저자·짧은 제목·페이지)로 간소화합니다." }, { q: "여러 인용을 한 각주에?", a: "세미콜론(;)으로 구분합니다. 예: '김철수, 책1, 23; 이영희, 책2, 45.'" }, { q: "워드에서 각주 자동 번호 매기기?", a: "워드 '참조 → 각주 삽입'으로 자동 번호 매겨집니다. 본 도구는 형식만 생성, 번호 매기기는 워드 기능 활용." }], addedAt: "2026-05-17" },

  // ===== Batch H - calc 추가 =====
  { slug: "loan-calc", component: "LoanCalcTool", category: "calc", icon: "🏦", navTitle: "대출 이자 계산기", title: "대출 이자 계산기 - 원리금균등 · 원금균등 · 만기일시 (주택담보·신용)", h1: "대출 이자 / 월 상환액 계산기", description: "대출 원금·이자율·기간을 입력해 원리금균등, 원금균등, 만기일시상환 3가지 방식의 월 상환액과 총 이자를 계산합니다. 주택담보대출(LTV) 시뮬레이션, 전세자금대출, 신용대출, 자동차 할부 등 다양한 대출 비교에 자주 쓰입니다.", metaDescription: "대출 이자 계산 무료. 원리금균등 원금균등 만기일시 상환 시뮬레이션.", howTo: ["대출 원금, 연 이자율, 기간(개월)을 입력합니다.", "상환 방식을 선택합니다.", "월 납입금과 총 이자를 확인합니다."], faq: [{ q: "원리금균등 vs 원금균등?", a: "원리금균등은 매월 같은 금액을 갚아 가계 부담이 일정합니다. 원금균등은 첫 달이 가장 많고 점차 줄어들며 총 이자가 더 적습니다." }, { q: "중도상환수수료는?", a: "이 계산기는 단순 시뮬레이션이며 실제 은행 수수료·DSR 규제 등은 별도로 확인하세요. 보통 3년 이내 상환 시 1~2%." }, { q: "DSR이 뭐예요?", a: "총부채원리금상환비율. 연소득 대비 모든 대출의 연간 상환액 비율. 한국 은행 대출은 보통 DSR 40% 이내." }, { q: "만기일시상환 언제 써요?", a: "전세자금대출이 대표적. 매월 이자만 내고 만기에 원금을 한 번에 갚습니다. 보증금 반환 시기에 맞춰 설계." }, { q: "변동 금리도 계산할 수 있나요?", a: "이 도구는 고정 금리 기준. 변동 금리는 시뮬레이션 어려우니 은행 상담사·금융감독원 계산기를 활용하세요." }, { q: "스트레스 DSR이 뭐예요?", a: "변동 금리 대출의 미래 금리 상승 위험을 반영해 추가 가산 금리(1~1.5%)를 적용하는 규제. 2024년부터 시행." }], addedAt: "2026-05-17" },
  { slug: "savings-calc", component: "SavingsCalcTool", category: "calc", icon: "💰", navTitle: "적금·예금 계산기", title: "적금 / 예금 만기금액 계산 - 단리 · 복리 · 세후 (15.4% 이자소득세)", h1: "적금 · 예금 만기금액 계산기", description: "정기적금·정기예금의 단리/복리 만기금액을 계산합니다. 이자소득세 15.4% 자동 차감, 비과세 옵션 지원. 청년도약계좌·ISA·일반 적금 비교, 은행별 상품 수익 시뮬레이션, 목돈 마련 계획에 자주 쓰입니다.", metaDescription: "적금 예금 계산 무료. 단리 복리 만기금액, 이자과세 비과세 ISA.", howTo: ["적금 또는 예금을 선택합니다.", "월 적립액(예치 원금), 이자율, 기간을 입력합니다.", "세후 만기 수령액을 확인합니다."], faq: [{ q: "적금과 예금 차이?", a: "적금은 매월 일정액 적립, 예금은 처음 한 번에 예치합니다. 이자 계산 방식이 달라 같은 이자율이어도 결과가 다릅니다." }, { q: "이자소득세란?", a: "일반 이자에 부과되는 15.4% 세금(소득세 14% + 지방세 1.4%). 청년도약계좌·ISA 등은 비과세." }, { q: "단리와 복리?", a: "단리는 원금에만 이자, 복리는 이자에도 이자. 한국 일반 은행 적금은 대부분 단리, 일부 특수상품·외국이 복리." }, { q: "청년도약계좌 vs 일반 적금?", a: "청년도약계좌는 5년 만기 비과세 + 정부 기여금이라 수익률이 일반 적금의 2~3배. 만 19~34세 가입 가능." }, { q: "예금 이자율이 낮은데 다른 방법?", a: "RP·CMA·MMF는 예금과 비슷한 안전성에 약간 높은 수익. ISA는 비과세 + 다양한 상품 투자. 본인 위험 감수도에 따라 선택." }, { q: "월 30만원 5년 적금 만기액?", a: "단리 4% 기준 약 1,857만원(원금 1,800만 + 세후 이자 약 57만). 도구로 정확히 계산 가능." }], addedAt: "2026-05-17" },
  { slug: "net-salary", component: "NetSalaryTool", category: "calc", icon: "💵", navTitle: "연봉 실수령액", title: "연봉 실수령액 계산기 - 4대보험 · 소득세 자동 공제 (2026 기준)", h1: "연봉 → 월 실수령액 계산기", description: "연봉에서 국민연금·건강보험·고용보험·소득세·지방소득세를 모두 공제한 월 실수령액을 계산합니다. 부양가족·자녀·비과세 반영. 입사 전 실수령 가늠, 이직 시 연봉 비교, 가계 예산 짜기, 협상 자료 준비에 자주 쓰입니다.", metaDescription: "연봉 실수령액 무료 계산. 4대보험 소득세 공제, 부양가족 자녀 비과세.", howTo: ["연봉(원)을 입력합니다.", "본인 포함 부양가족 수와 자녀 수를 입력합니다.", "비과세 항목(식대 등)을 입력합니다.", "월 실수령액과 공제 내역을 확인합니다."], faq: [{ q: "왜 회사 명세서와 달라요?", a: "소득세는 회사가 국세청 간이세액표에서 lookup하며, 연말정산 결과에 따라 환급/추가납부가 발생합니다. 이 계산은 누진 근사로 ±5% 정도 오차가 있을 수 있습니다." }, { q: "비과세 한도?", a: "식대 월 20만원, 자가운전보조금 월 20만원, 교통비 등이 비과세입니다." }, { q: "4대보험 요율은?", a: "국민연금 4.5%, 건강보험 3.545%, 장기요양 건강보험료의 12.95%, 고용보험 0.9%. 본인부담분이며 회사도 동일 금액 부담." }, { q: "연봉 5,000만원 실수령액?", a: "공제 후 약 월 350~360만원(부양가족 1인 기준). 부양가족·자녀에 따라 변동." }, { q: "퇴직금 포함인가요?", a: "이 계산은 통상 연봉(상여·퇴직금 별도)만 처리합니다. 회사마다 연봉 포함 범위가 달라 계약서 확인 필요." }, { q: "성과급·인센티브는?", a: "지급 시점에 따로 세금 계산. 평소 월급보다 세율이 높게 잡힐 수 있어 받을 때 30% 정도 차감 예상." }], addedAt: "2026-05-17" },
  { slug: "gpa", component: "GpaTool", category: "calc", icon: "🎓", navTitle: "GPA 학점 계산기", title: "대학 학점 GPA 계산기 - 4.5 · 4.3 · 4.0 척도 환산 (유학용)", h1: "GPA 학점 계산기 (4.5 · 4.3 · 4.0)", description: "과목명·등급·학점을 입력해 GPA를 계산하고 4.5, 4.3, 4.0, 100점 척도로 환산합니다. P/NP·재수강 등 처리. 학기말 자가 점검, 유학·대학원 지원용 영문 GPA 환산, 장학금 신청 자료 준비에 자주 쓰입니다.", metaDescription: "GPA 학점 계산 무료. 4.5 4.3 4.0 척도 환산, 유학 미국 대학원.", howTo: ["학교의 척도(4.5/4.3/4.0)를 선택합니다.", "과목명·등급·학점을 입력합니다.", "GPA와 환산 점수를 확인합니다."], faq: [{ q: "어떤 척도를 써야 하나요?", a: "한국 대학 다수가 4.5점 척도 (서울대·한양대·이대 등), 미국 대학은 4.0점 척도, 연·고대 등은 4.3점이 흔합니다." }, { q: "유학용 환산?", a: "WES·ECE 같은 학점 환산 기관은 한국 GPA를 미국식 4.0으로 변환합니다. 이 계산기는 단순 비례 환산이므로 참고용입니다." }, { q: "재수강 학점은?", a: "대부분 학교는 재수강 시 새 학점이 기록되고 이전 학점은 GPA 계산에서 제외됩니다. 학교 규정 확인 필수." }, { q: "P/NP(Pass/No Pass)는?", a: "보통 GPA 계산에서 제외됩니다. 학점은 인정되지만 평점에는 영향 없음. 도전 과목·교양 선택에 자주 사용." }, { q: "전공 GPA만 따로 계산?", a: "전공 과목만 골라 입력하면 됩니다. 일부 대학원·기관은 전공 GPA를 더 중요시합니다." }, { q: "백분율 환산이 정확한가요?", a: "단순 비례 환산이라 실제 점수와 차이가 있을 수 있습니다. 정확한 백분율은 학교 성적증명서에 표시된 환산 사용." }], addedAt: "2026-05-17" },
  { slug: "pyeong", component: "PyeongTool", category: "calc", icon: "🏠", navTitle: "평 ↔ ㎡ 변환", title: "평 ↔ 제곱미터 변환기 - 부동산 평수 환산 (전용·분양·공급면적)", h1: "평 ↔ ㎡ 부동산 평수 환산", description: "평을 제곱미터로, 제곱미터를 평으로 정확히 환산합니다. 원룸·30평대 등 자주 쓰는 평수 프리셋과 전용면적 추정 제공. 부동산 매물 평수 가늠, 이사 시 평수 비교, 가구 배치 계획, 인테리어 견적에 자주 쓰입니다.", metaDescription: "평 제곱미터 변환 무료. 부동산 평수 계산, 전용면적 분양면적.", howTo: ["평 또는 ㎡를 입력하면 다른 단위로 자동 변환됩니다.", "자주 쓰는 평수 프리셋을 클릭해 비교합니다."], faq: [{ q: "1평이 정확히 몇 ㎡?", a: "1평 = 400/121 ≈ 3.3058㎡. 일제강점기에 도입된 단위로, 법적으로는 ㎡가 표준입니다." }, { q: "전용면적과 분양면적?", a: "전용면적은 실제 사용 공간, 분양면적은 공용 공간(엘리베이터·계단)을 포함합니다. 한국 아파트 전용률은 보통 70~80%입니다." }, { q: "30평대 아파트가 ㎡로?", a: "분양 30평 ≈ 99㎡, 전용 25평 ≈ 84㎡. 한국 흔한 4인 가족 평수입니다." }, { q: "원룸 평수는 보통?", a: "오피스텔·원룸은 보통 8~12평(전용 20~30㎡). 매물 광고는 분양면적이라 더 크게 표시됩니다." }, { q: "공급면적·서비스면적이 뭐예요?", a: "공급면적 = 전용 + 주거공용(계단·복도). 서비스면적 = 베란다 등 분양면적 외 추가 공간. 광고는 보통 공급면적." }, { q: "평수로 가구 배치 어떻게 계산?", a: "전용면적 ㎡로 보세요. 침대·소파 크기(예: 퀸 침대 약 1.5×2m = 3㎡)를 빼면 실제 활용 공간이 나옵니다." }], addedAt: "2026-05-17" },
  ...
  { slug: "stat-tables", component: "StatTablesTool", category: "calc", icon: "📋", navTitle: "확률분포표 (z·t)", title: "표준정규분포표(z표)·t분포표 - 임계값 조회와 계산", h1: "확률분포표 — z표 & t분포표", description: "표준정규분포표(z표)와 t분포 임계값표를 한 곳에서. z값을 넣으면 누적확률 Φ(z)를, 확률을 넣으면 z값을 바로 계산하고, 자유도별 t 임계값(α = 0.10~0.005)을 표로 제공합니다. 통계 수업·시험·논문의 가설검정과 신뢰구간 계산에 바로 사용하세요.", metaDescription: "표준정규분포표(z표)·t분포표 무료. Φ(z) 계산기, 역계산, 자유도별 t 임계값.", howTo: ["z표 탭에서 z값→누적확률, 확률→z값을 바로 계산합니다.", "표에서 행(z 소수 첫째 자리)과 열(둘째 자리)이 만나는 칸이 Φ(z)입니다.", "t표 탭에서 자유도(df)와 단측 α가 만나는 칸이 임계값입니다. 양측검정은 α를 반으로 나눠 보세요."], faq: [{ q: "값이 교과서 표와 같나요?", a: "네. 수치 적분으로 계산하며 교과서 표와 동일합니다 (예: t(10, 0.05)=1.812, Φ(1.96)=0.9750)." }, { q: "양측검정은 어떻게 보나요?", a: "양측 α=0.05라면 단측 α=0.025 열을 보면 됩니다. 표 하단에 안내가 있습니다." }, { q: "자유도가 표에 없으면?", a: "표는 df 1~30, 40, 60, 120과 ∞(=z)를 제공합니다. 사이 값은 보간하거나 더 보수적인(작은) df를 사용하세요." }], addedAt: "2026-06-10" },
  { slug: "physics-constants", component: "PhysicsConstantsTool", category: "calc", icon: "🔬", navTitle: "물리 상수표", title: "물리 상수표 - CODATA 기준 25개 상수 검색·복사", h1: "물리 상수표 (CODATA)", description: "빛의 속력 c, 플랑크 상수 h, 기본 전하 e, 아보가드로 수, 볼츠만 상수, 기체 상수 R 등 물리·화학에서 자주 쓰는 상수 25개를 CODATA 기준 값으로 제공합니다. 이름·기호·단위로 검색하고, 클릭 한 번으로 계산기에 붙여넣기 좋은 e표기(예: 6.626e-34)로 복사됩니다.", metaDescription: "물리 상수표 무료. 빛의 속력·플랑크 상수·아보가드로 수 등 CODATA 값, 검색·복사.", howTo: ["검색창에 이름(플랑크), 기호(h), 단위(J·s) 아무거나 입력해 찾습니다.", "[복사]를 누르면 6.626e-34 같은 계산기용 표기로 복사됩니다.", "공학용 계산기 도구에 붙여넣어 바로 계산하세요."], faq: [{ q: "값의 출처는?", a: "CODATA 2018 권장값 기준입니다. c, h, e, k_B, N_A는 2019년 SI 재정의로 정확히 고정된 값입니다." }, { q: "복사하면 어떤 형식인가요?", a: "지수 표기를 계산기 친화적인 e표기로 바꿔 복사합니다. 예: 6.62607015 × 10⁻³⁴ → 6.62607015e-34." }, { q: "화학 상수도 있나요?", a: "네. 아보가드로 수, 기체 상수 R, 패러데이 상수, 몰부피 등 물리화학 상수를 포함합니다." }], addedAt: "2026-06-10" },
  { slug: "chart-maker", component: "ChartMakerTool", category: "calc", icon: "📊", navTitle: "그래프 만들기", title: "그래프 만들기 - 원그래프·막대·선 차트를 PNG·SVG로", h1: "그래프(차트) 만들기", description: "데이터를 입력하면 원그래프(파이), 도넛, 막대그래프, 가로 막대, 선 그래프를 즉시 만들고 PNG 또는 SVG로 다운로드합니다. 제목·색상 팔레트·범례·값 표시를 자유롭게 켜고 끌 수 있습니다. 발표 자료, 보고서, 과제, SNS 이미지에 유용합니다. 모든 처리는 브라우저에서만 이루어져 데이터가 서버로 전송되지 않습니다.", metaDescription: "그래프 만들기 무료. 원그래프·막대·선 차트를 데이터 입력만으로, PNG·SVG 다운로드.", howTo: ["그래프 종류(원·도넛·막대·가로막대·선)를 고릅니다.", "데이터 표에 항목 이름과 값을 입력하고 필요하면 행을 추가합니다.", "제목·색상·범례·값 표시를 조정합니다.", "[PNG] 또는 [SVG]로 다운로드하거나 이미지를 복사합니다."], faq: [{ q: "어떤 형식으로 저장되나요?", a: "PNG(비트맵, 2배 해상도)와 SVG(벡터, 크기 무제한 확대 가능)로 다운로드할 수 있고, 클립보드로 PNG 복사도 됩니다." }, { q: "데이터가 서버로 전송되나요?", a: "아니요. 모든 그래프 생성은 브라우저 안에서만 이루어집니다." }, { q: "한글 제목·라벨도 되나요?", a: "네. 한글·영문·숫자 모두 지원되며 PNG·SVG에 그대로 들어갑니다." }, { q: "몇 개까지 넣을 수 있나요?", a: "항목 수 제한은 없지만, 원·도넛 그래프는 5~8개, 막대·선은 12개 이내가 가장 보기 좋습니다." }], addedAt: "2026-06-24" },
  ...
  },
  {
    ...
    icon: "🧮",
    navTitle: "공학용 계산기",
    title: "공학용 계산기 - 행렬·통계·방정식·삼각함수 한 번에",
    h1: "공학용 계산기",
    description:
      "행렬·통계·방정식까지 다루는 고급 공학용 계산기. 식 입력 방식 과학계산(삼각·로그·지수·분수·Ans·변수저장), 다항식·방정식 솔버, 행렬 연산(행렬식·역행렬·rref·연립방정식), 통계(평균·표준편차·사분위·선형회귀)까지 한 곳에서. 모두 브라우저에서 즉시 계산.",
    metaDescription:
      "공학용 계산기 무료 - 삼각함수·로그·분수, 방정식 솔버, 행렬(역행렬·행렬식·rref), 통계·회귀. 식 입력 방식, 그래핑 계산기급.",
    howTo: [
      "탭을 선택합니다: 계산 · 방정식 · 행렬 · 통계.",
      "계산 탭에서 식을 입력하거나 키패드를 누릅니다 (예: sin(30)+ncr(5,2)). DEG/RAD/GRAD, ▶Frac(분수), Ans·변수저장 지원.",
      "방정식 탭에서 다항식 계수 또는 f(x)와 구간을 넣어 근을 구합니다.",
      "행렬 탭에서 A·B를 입력해 행렬식·역행렬·곱·rref·연립방정식을 계산합니다.",
      "통계 탭에서 숫자 목록을 넣어 평균·표준편차·사분위·선형회귀를 구합니다.",
    ],
    faq: [
      { q: "각도 단위를 바꿀 수 있나요?", a: "계산 탭 상단에서 DEG(도)·RAD(라디안)·GRAD(그라드)를 선택할 수 있습니다. MODE 키로도 순환됩니다." },
      { q: "이전 결과나 변수를 다시 쓸 수 있나요?", a: "Ans 키로 직전 결과를 불러오고, A~Z 변수에 'Ans 저장' 후 식에서 그 문자를 그대로 쓸 수 있습니다 (예: A^2)." },
      { q: "분수로 답을 볼 수 있나요?", a: "계산 탭의 ▶Frac을 켜면 결과가 유리수일 때 a/b 분수 형태로 함께 표시됩니다." },
      { q: "행렬은 어디까지 되나요?", a: "최대 5×5까지 덧·뺄셈, 곱, 스칼라배, 행렬식(det), 역행렬, 전치, rref, 그리고 Ax=b 연립방정식 풀이를 지원합니다." },
      { q: "방정식 솔버는 복소근도 구하나요?", a: "다항식(2~4차) 솔버는 실근과 복소근을 모두 구해 a±bi로 표시합니다. f(x)=0 솔버는 지정 구간 안의 실근을 수치적으로 찾습니다." },
      { q: "그래프도 그릴 수 있나요?", a: "그래프가 필요하면 별도의 [그래픽 계산기] 도구를 사용하세요. 각 탭 하단에 바로가기 링크가 있습니다." },
    ],
    addedAt: "2026-05-14",
  },
  {
  ...
  // ===== Batch H (50 tools) =====
  { slug: "image-invert", component: "ImageInvertTool", category: "image", icon: "◐", navTitle: "이미지 색반전", title: "이미지 색반전 (네거티브) - 음화 효과 무료", h1: "이미지 색 반전 / 네거티브", description: "이미지 색상을 반전해 음화(네거티브) 효과를 만들어요. 옛 필름 사진 느낌 재현, 다크 모드용 이미지 변환, 흑백 다이어그램 색 반전, 디자인 콘셉트 실험에 자주 쓰입니다.", metaDescription: "이미지 색반전 무료. 네거티브 효과, 즉시 변환.", howTo: ["이미지를 업로드합니다.", "반전 효과가 자동 적용됩니다.", "결과를 다운로드합니다."], faq: [{ q: "투명도는?", a: "투명도는 유지되고 색만 반전됩니다. PNG 투명 배경은 그대로 유지." }, { q: "흑백 이미지에 적용하면?", a: "검정 → 흰색, 흰색 → 검정으로 단순 반전됩니다. 다크 모드용으로 자주 활용." }, { q: "다시 원본으로?", a: "반전된 결과에 한 번 더 반전을 적용하면 원본으로 돌아옵니다 (수학적으로 완전 가역)." }, { q: "PDF에서도 색반전 가능?", a: "이 도구는 이미지 전용. PDF 색반전은 별도 도구 필요. 또는 [PDF → 이미지]로 변환 후 색반전 후 다시 PDF로." }, { q: "다크 모드 자동 변환에 좋아요?", a: "단순 반전은 색감이 어색해질 수 있습니다. 진짜 다크 모드는 디자인을 다시 하는 게 좋아요." }], addedAt: "2026-05-15" },
  { slug: "image-watermark-img", component: "ImageWatermarkImgTool", category: "image", icon: "🏷️", navTitle: "이미지 워터마크", title: "이미지 워터마크 - 로고/이미지 워터마크 삽입 (저작권 보호)", h1: "이미지 워터마크 (이미지로)", description: "사진에 로고나 이미지를 워터마크로 얹습니다. 위치·투명도·크기 조절. 사진 작가 저작권 표시, 블로그·SNS 사진 도용 방지, 회사 로고 워터마크, 강의 자료 출처 표시에 자주 쓰입니다.", metaDescription: "이미지 워터마크 무료. 로고 삽입, 위치·투명도 조절.", howTo: ["배경 이미지를 업로드합니다.", "워터마크 이미지(로고 PNG)를 업로드합니다.", "위치·크기·투명도를 조절합니다.", "결과를 다운로드합니다."], faq: [{ q: "위치 자유?", a: "9개 위치 선택 + 미세 조정 가능. 오른쪽 하단이 가장 흔하며 본문 가독성을 해치지 않습니다." }, { q: "투명한 PNG 로고가 좋아요?", a: "네. 배경이 투명한 PNG가 자연스럽게 어우러집니다. 흰색 배경 로고는 사각형 박스가 보일 수 있어요." }, { q: "투명도 얼마가 적당?", a: "30~50% 정도가 보기 좋습니다. 너무 진하면 본문을 가리고, 너무 흐리면 워터마크 효과가 약합니다." }, { q: "워터마크가 잘려요?", a: "워터마크 크기가 너무 크거나 위치가 가장자리에 너무 가까운 경우입니다. 크기·위치를 조정하세요." }, { q: "여러 이미지에 일괄 적용?", a: "현재는 한 장씩 처리됩니다. 여러 장을 같은 워터마크로 처리하려면 같은 설정으로 순서대로 적용." }, { q: "텍스트 워터마크가 필요하면?", a: "[이미지에 글자 넣기] 도구를 사용하세요. 텍스트 + 외곽선 + 위치 조절이 가능." }], addedAt: "2026-05-15" },
  { slug: "image-color-transparent", component: "ImageColorTransparentTool", category: "image", icon: "🟦", navTitle: "특정 색 → 투명", title: "이미지 특정 색을 투명으로 - 배경 색 제거 (PNG 투명화)", h1: "이미지 색상 → 투명", description: "이미지에서 특정 색(보통 흰색 배경)을 투명으로 만듭니다. 로고 흰 배경 제거, 도장·서명 이미지 정리, 캐릭터·아이콘 추출, PPT 삽입용 투명 이미지 만들기에 자주 쓰입니다.", metaDescription: "이미지 배경색 투명 무료. PNG 투명화, 단색 배경 제거.", howTo: ["이미지를 업로드합니다.", "투명으로 만들 색상을 선택합니다.", "허용 범위(유사 색까지)를 조정합니다.", "PNG로 저장합니다."], faq: [{ q: "복잡한 배경도?", a: "단색 배경에만 효과적입니다. 그라데이션·자연 사진 배경은 AI 기반 배경 제거 도구가 더 적합합니다." }, { q: "허용 범위가 뭐예요?", a: "선택한 색과 비슷한 색까지 투명 처리. 예: 흰색 선택에 허용 30이면 옅은 회색까지 투명. 너무 크면 본문도 사라져요." }, { q: "JPG로 저장하면 투명도 사라지나요?", a: "네. JPG는 투명도 미지원. 반드시 PNG로 저장하세요." }, { q: "스캔한 도장·서명을 투명하게?", a: "네. 흰 배경 스캔본은 이 도구로 깔끔하게 투명 처리 가능. 그 뒤 [이미지 워터마크]로 다른 사진에 얹을 수 있어요." }, { q: "사진 인물 배경만 제거하려면?", a: "이 도구로는 어렵습니다. AI 기반 배경 제거 서비스(remove.bg 등)가 적합합니다." }, { q: "여러 색을 동시에 제거?", a: "한 번에 한 색만 처리합니다. 결과를 다시 업로드해 다른 색을 처리하면 누적 적용 가능." }], addedAt: "2026-05-15" },
  { slug: "image-channels", component: "ImageChannelsTool", category: "image", icon: "🎚️", navTitle: "RGB 채널 분리", title: "이미지 RGB 채널 분리 - 빨강 / 녹색 / 파랑 채널 보기", h1: "이미지 RGB 채널 분리", description: "이미지의 빨강·녹색·파랑 채널을 각각 분리해 그레이스케일 이미지로 보여줍니다. 사진 합성 작업, 색상 분석, 디지털 포렌식, 인쇄 분판 미리보기, 디자인 학습에 자주 쓰입니다.", metaDescription: "이미지 RGB 채널 분리 무료. 빨강 녹색 파랑 별도 보기.", howTo: ["이미지를 업로드합니다.", "각 채널(R·G·B)이 자동 표시됩니다.", "원하는 채널 이미지를 저장합니다."], faq: [{ q: "왜 채널 분리가 필요해요?", a: "(1) 사진 합성·보정 시 특정 채널만 강조, (2) 카메라 센서 문제 진단, (3) 디자인 학습용 이미지 분해." }, { q: "각 채널이 왜 흑백으로 보여요?", a: "각 채널은 한 가지 색의 강도만 가지므로 흑백(그레이스케일)으로 표현됩니다. 흰색 = 그 색 100%, 검정 = 0%." }, { q: "빨간 사물은 어느 채널이 밝아요?", a: "빨강 채널이 가장 밝게, 녹색·파랑 채널은 어둡게 보입니다. 색의 본질을 시각화하는 도구." }, { q: "RGB 외에 CMYK·HSL은?", a: "본 도구는 RGB만 지원합니다. CMYK는 인쇄용 색 공간이며 별도 도구가 필요합니다." }, { q: "분리된 채널을 다시 합칠 수 있나요?", a: "이 도구는 분리만 합니다. 합치려면 포토샵·GIMP의 채널 합성 기능이 필요합니다." }, { q: "사진 학습에 좋은 방법?", a: "RGB 채널을 따로 보면 빛의 합성 원리와 디지털 색 표현 방식을 직관적으로 이해할 수 있습니다." }], addedAt: "2026-05-15" },
  { slug: "image-free-rotate", component: "ImageFreeRotateTool", category: "image", icon: "↻", navTitle: "이미지 임의 각도", title: "이미지 임의 각도 회전 - 1° 단위 정밀 회전 (수평 보정)", h1: "이미지 1° 단위 회전", description: "이미지를 1° 단위로 자유롭게 회전합니다. 스마트폰으로 비뚤게 찍힌 사진의 수평선 보정, 스캔본 기울어진 문서 펴기, 디자인 효과, 명함·청첩장 회전 디자인에 자주 쓰입니다.", metaDescription: "이미지 임의 각도 회전 무료. 1° 단위, 수평 보정.", howTo: ["이미지를 업로드합니다.", "각도 슬라이더로 조절합니다 (-180° ~ +180°).", "여백 색상을 선택합니다.", "결과를 다운로드합니다."], faq: [{ q: "여백은?", a: "회전 시 생기는 빈 공간은 투명 또는 선택한 색으로 채워집니다. 투명은 PNG로만 저장 가능." }, { q: "직각 회전과 차이?", a: "직각(90·180·270)은 [이미지 회전] 도구가 더 빠릅니다. 그 외 각도는 이 도구가 정밀합니다." }, { q: "회전 후 화질이 떨어져요?", a: "임의 각도 회전은 픽셀을 보간(interpolate)해 약간의 흐림이 생깁니다. 직각 회전은 무손실, 임의 각도는 미세 손실." }, { q: "수평선이 비뚤어진 풍경 사진?", a: "수평선과 일치하도록 -1~3° 정도 회전하면 보통 정상화됩니다. 미세 조정 슬라이더 사용." }, { q: "회전 후 가장자리 자르려면?", a: "회전 결과를 다운로드 후 [이미지 자르기] 도구로 여백을 자르세요. 또는 자동 자르기 옵션이 있다면 활용." }, { q: "여러 사진 일괄 회전?", a: "현재는 한 장씩 처리됩니다. 모든 사진이 같은 각도로 비뚤어진 경우 같은 설정으로 차례대로." }], addedAt: "2026-05-15" },
  ...
  { slug: "pdf-images-extract", component: "PdfImagesExtractTool", category: "pdf", icon: "🖼️", navTitle: "PDF 이미지 추출", title: "PDF 페이지를 이미지로 일괄 추출 (고해상도 PNG)", h1: "PDF에서 이미지 추출", description: "PDF 각 페이지를 고해상도 PNG로 렌더링해 ZIP 묶음으로 저장합니다. 슬라이드 자료에 PDF 사용, 강의 자료 캡처, 블로그·SNS에 PDF 내용 공유, 카드뉴스 만들기에 자주 쓰입니다.", metaDescription: "PDF 이미지 추출 무료. 고해상도 PNG, ZIP 일괄 다운로드.", howTo: ["PDF를 업로드합니다.", "해상도(배율 1x~3x)를 선택합니다.", "추출 버튼을 누르면 각 페이지가 PNG로 변환됩니다.", "ZIP을 다운로드합니다."], faq: [{ q: "원본 임베드 이미지 추출도 됩니까?", a: "현재는 페이지 전체를 렌더링한 PNG입니다. 원본 임베드 이미지(JPG·PNG)만 빼내는 건 별도 도구가 필요합니다." }, { q: "[PDF → 이미지] 도구와 차이?", a: "거의 비슷합니다. 이 도구는 고해상도·일괄 ZIP 묶음 특화, [PDF → 이미지]는 형식·해상도 더 유연한 옵션." }, { q: "한 페이지만 추출?", a: "ZIP에서 원하는 페이지만 꺼내 쓰면 됩니다. 또는 [PDF 페이지 추출]로 한 페이지만 빼낸 뒤 이미지화." }, { q: "스캔본 PDF는 어떻게?", a: "스캔본도 페이지를 PNG로 렌더링하므로 잘 됩니다. 원본 스캔 화질이 그대로 유지." }, { q: "JPG로 저장하려면?", a: "기본은 PNG입니다. 다운로드 후 [PNG → JPG] 도구로 일괄 변환 가능합니다." }], addedAt: "2026-05-15" },
  ...
  { slug: "beat-maker", component: "BeatMakerTool", category: "video", icon: "🥁", navTitle: "비트 메이커", title: "비트 메이커 - 브라우저에서 음악 만들기 (무료, 설치 없음)", h1: "비트 메이커 (음악 만들기)", description: "설치 없이 브라우저에서 나만의 비트를 만드세요. 드럼 4종(킥·스네어·하이햇·클랩)과 멜로디 8음(펜타토닉 음계) 16스텝 시퀀서로, 아무 칸이나 눌러도 듣기 좋은 음악이 됩니다. 완성한 비트는 WAV 파일로 다운로드해 영상 배경음·알림음·샘플로 쓸 수 있습니다. 모든 소리는 웹오디오로 즉석 합성되어 저작권 걱정이 없고, 어디에도 업로드되지 않습니다.", metaDescription: "무료 온라인 비트 메이커. 16스텝 드럼+멜로디 시퀀서, WAV 다운로드, 설치·가입 없음.", howTo: ["칸을 눌러 드럼과 멜로디를 찍습니다. 멜로디는 펜타토닉 음계라 아무렇게나 찍어도 어울립니다.", "[재생]으로 반복해서 들으며 BPM(빠르기)을 조절합니다.", "[WAV 다운로드]를 누르면 4마디 분량이 파일로 저장됩니다."], faq: [{ q: "만든 음악을 상업적으로 써도 되나요?", a: "네. 모든 소리는 브라우저에서 수학적으로 합성한 것이라 샘플 저작권이 없습니다. 자유롭게 쓰세요." }, { q: "왜 아무렇게나 찍어도 듣기 좋나요?", a: "멜로디 8음이 C장조 펜타토닉(5음) 음계로만 구성돼 있어, 서로 부딪히는 음이 없기 때문입니다. 작곡 입문 교육에도 쓰이는 방식입니다." }, { q: "WAV 파일은 어떤 사양인가요?", a: "44.1kHz 16비트 모노 WAV로, 현재 패턴 4회 반복(4마디) 분량입니다. 영상 편집기·DAW 어디서든 열립니다." }, { q: "소리가 안 나요.", a: "휴대폰이 무음 모드인지 확인하세요. iOS에서는 화면을 한 번 터치한 뒤 재생해야 소리가 납니다." }, { q: "패턴을 저장할 수 있나요?", a: "현재는 WAV 다운로드만 지원합니다. 페이지를 새로고침하면 패턴이 초기화되니, 완성하면 바로 다운로드하세요." }, { q: "박자를 더 잘게 쪼갤 수 있나요?", a: "16스텝은 한 마디를 16분음표로 나눈 것입니다. BPM을 올리면 더 촘촘한 느낌을 낼 수 있습니다." }], addedAt: "2026-08-08" },
  ...
  {
    slug: "kakaotalk-chat",
    component: "KakaoChatTool",
    category: "image",
    icon: "💬",
    navTitle: "카카오톡 채팅 캡처 생성기",
    title: "카카오톡 채팅 캡처 생성기 - 가짜 카톡 대화 이미지 만들기",
    h1: "카카오톡 채팅 캡처 생성기",
    description:
      "카카오톡 스타일의 가짜 채팅 화면을 만들어 PNG로 다운로드합니다. 블로그 후기/소설/유머/예시 시나리오/광고 미리보기 등에 사용. 상대방 이름·메시지·시간 자유 입력. 실제 카카오톡과 시각적으로 비슷한 말풍선 디자인.",
    metaDescription:
      "카카오톡 채팅 캡처 무료 생성기. 가짜 카톡 대화, 블로그/유머/예시용 이미지.",
    howTo: [
      "상단에 채팅방 이름과 상대 이름을 입력합니다.",
      "메시지를 한 줄씩 추가합니다 (좌/우 발신자, 시간 선택).",
      "PNG로 다운로드합니다.",
    ],
    faq: [
      { q: "실제 카카오톡과 똑같은가요?", a: "시각적으로 유사하게 디자인했지만 100% 동일하진 않습니다. 사기나 협박 용도로 사용하면 법적 처벌될 수 있으니 합법적 용도로만 사용하세요." },
      { q: "사기·협박용으로 쓰면 안 되나요?", a: "정보통신망법, 형법상 사기·협박·명예훼손 등으로 처벌될 수 있습니다. 본 도구는 블로그 후기, 유머, 소설, 광고 미리보기 등 합법적 용도로 제공됩니다." },
      { q: "프로필 사진도 넣을 수 있나요?", a: "기본 아이콘으로 표시됩니다. 추후 업데이트에 사진 업로드 기능을 추가할 예정입니다." },
      { q: "다크모드도 됩니까?", a: "라이트/다크 토글로 두 가지 스타일을 모두 만들 수 있습니다." },
      { q: "이미지로 받으면 어떻게 활용하나요?", a: "블로그 후기 보강용, 유튜브 썸네일, 광고 시나리오 미리보기, 소설 일러스트, SNS 카드뉴스 등." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    icon: "😂",
    navTitle: "밈 생성기",
    title: "밈 생성기 - 이미지에 상하단 텍스트 합성",
    h1: "밈(Meme) 생성기",
    description:
      "이미지를 업로드하고 상단·하단 텍스트를 넣어 클래식 밈 이미지를 만듭니다. 폰트 크기·색상·외곽선 조절, PNG 다운로드. SNS 공유, 채팅 짤, 유튜브 썸네일, 블로그 유머 게시물에 활용.",
    metaDescription:
      "밈 생성기 무료. 이미지 상하단 텍스트, 외곽선·색상 조절, PNG 다운로드.",
    howTo: [
      "사진을 업로드합니다.",
      "상단·하단 텍스트를 입력합니다.",
      "폰트 크기와 색상을 조절합니다.",
    ...
    faq: [
      { q: "어떤 폰트를 쓰나요?", a: "전통적인 밈 스타일의 Impact 폰트와 한글용 굵은 고딕을 기본 제공합니다." },
      { q: "외곽선은 왜 필요한가요?", a: "어두운 배경에서 흰 글자가 잘 보이게 합니다. 검은 외곽선이 표준 밈 스타일입니다." },
      { q: "워터마크가 들어가나요?", a: "아니요. 무료, 워터마크 없음." },
      { q: "어떤 이미지 포맷을 받나요?", a: "JPG, PNG, WebP, HEIC 등 모든 일반 이미지 포맷을 지원합니다." },
      { q: "이미지 합성 후 사이즈는?", a: "원본 크기 유지. 큰 이미지는 그대로 다운로드되니 SNS 업로드 전 별도 리사이즈가 필요할 수 있습니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    category: "image",
    icon: "🎨",
    navTitle: "이미지 색 추출 (픽셀)",
    title: "이미지 색 추출기 - 사진 한 점의 HEX/RGB 색상값",
    h1: "이미지 픽셀 색 추출기",
    description:
      "이미지를 업로드하고 원하는 지점을 클릭하면 그 픽셀의 HEX/RGB/HSL 색상값을 즉시 알려줍니다. 디자인 시안 색 매칭, 브랜드 컬러 추출, 사진 속 특정 색 식별, PPT/포스터 색 통일에 유용.",
    metaDescription:
      "이미지 색 추출기 무료. 사진 클릭 → HEX/RGB/HSL 즉시. 디자인 시안 색 매칭용.",
    howTo: [
      "이미지를 업로드합니다.",
      "원하는 지점을 클릭하면 색상값이 표시됩니다.",
      "HEX 코드 복사 또는 여러 지점을 클릭해 팔레트 만들기.",
    ],
    faq: [
      { q: "[색 팔레트 추출]과 차이는요?", a: "[색 팔레트 추출]은 이미지 전체에서 자동으로 주요 색 N개를 뽑습니다. 이 도구는 원하는 픽셀 한 점의 정확한 색을 알려줍니다. 용도가 다릅니다." },
      { q: "줌인해서 정밀하게 찍을 수 있나요?", a: "마우스를 올리면 돋보기로 확대된 모습이 표시되어 정확한 픽셀을 클릭할 수 있습니다." },
      { q: "여러 색을 저장할 수 있나요?", a: "클릭한 색이 옆 패널에 누적 저장됩니다. 팔레트로 모아 복사하세요." },
      { q: "어떤 색 공간으로 표시되나요?", a: "HEX (#RRGGBB), RGB, HSL 세 가지를 모두 표시합니다." },
      { q: "사진은 외부로 가나요?", a: "아니요. 브라우저 안에서 처리되며 외부 전송되지 않습니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    category: "dev",
    icon: "🖼️",
    navTitle: "코드 → 이미지 (Carbon)",
    title: "코드 스크린샷 생성기 - Carbon 스타일 코드 이미지",
    h1: "코드 스크린샷 생성기",
    description:
      "소스 코드를 붙여넣고 언어를 선택하면 신택스 하이라이팅된 예쁜 코드 이미지(Carbon 스타일)를 PNG로 만듭니다. 블로그·SNS 공유, 트위터에 코드 자랑, 노션·발표 슬라이드에 코드 삽입, 코드 리뷰 캡처에 유용. 25+ 언어 지원.",
    metaDescription:
      "코드 스크린샷 무료 생성기. Carbon 스타일, 25+ 언어, PNG 다운로드.",
    howTo: [
      "코드를 붙여넣고 언어를 선택합니다.",
      "테마와 배경을 고릅니다.",
      "PNG로 다운로드해 SNS·블로그·발표에 사용합니다.",
    ],
    faq: [
      { q: "어떤 언어가 지원되나요?", a: "JavaScript, TypeScript, Python, Java, C/C++, C#, Go, Rust, PHP, Ruby, Swift, Kotlin, SQL, HTML, CSS, JSON, YAML, Markdown 등 25+." },
      { q: "Carbon (carbon.now.sh)과 같나요?", a: "유사한 스타일을 추구합니다. 핵심 기능(하이라이트·테마·창 디자인)을 동일하게 제공합니다." },
      { q: "투명 배경도 가능한가요?", a: "배경 색상을 흰색·검정·그라데이션 등에서 고를 수 있습니다." },
      { q: "고해상도 (Retina) 출력?", a: "2x 해상도로 출력하여 발표 슬라이드나 인쇄에도 선명합니다." },
      { q: "왜 SVG가 아닌 PNG?", a: "html2canvas 기반이라 PNG로 출력됩니다. 발표·SNS·블로그용 PNG가 일반적이라 적합합니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    icon: "🖼️",
    navTitle: "HTML → 이미지",
    title: "HTML to Image - HTML/CSS을 PNG 이미지로 렌더링",
    h1: "HTML을 PNG 이미지로",
    description:
      "HTML과 CSS 코드를 입력하면 그대로 렌더링한 결과를 PNG 이미지로 다운로드합니다. 데모/포트폴리오 미리보기, 디자인 시안 캡처, 이메일 템플릿 확인, 위젯 디자인 출력에 적합. html2canvas 기반.",
    metaDescription:
      "HTML to Image 무료. HTML/CSS을 PNG으로 렌더링, html2canvas 기반.",
    howTo: [
      "HTML 코드를 붙여넣습니다.",
      "원하는 너비를 설정합니다.",
      "PNG로 다운로드합니다.",
    ...
    faq: [
      { q: "어떤 CSS가 지원되나요?", a: "대부분의 표준 CSS. 다만 일부 최신 기능(backdrop-filter 등)이나 외부 폰트는 제한적입니다." },
      { q: "외부 이미지도 됩니까?", a: "CORS 허용된 이미지만 가능. 일반 외부 이미지는 보안상 차단될 수 있습니다. Base64 인라인 이미지가 안전합니다." },
      { q: "JavaScript는 실행되나요?", a: "안전상 JavaScript는 실행하지 않습니다. 순수 HTML+CSS 렌더링만 지원." },
      { q: "[코드 → 이미지]와 차이?", a: "[코드 → 이미지]는 코드를 표시한 스크린샷(신택스 하이라이팅). 이 도구는 HTML/CSS을 실제로 렌더링해 결과를 이미지로 만듭니다." },
      { q: "큰 페이지도 됩니까?", a: "너비를 지정하면 길이는 자동 조절됩니다. 다만 너무 크면 메모리 부족이 발생할 수 있습니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    slug: "svg-blob",
    component: "SvgBlobTool",
    category: "dev",
    icon: "🫧",
    navTitle: "SVG 블롭 생성기",
    title: "SVG 블롭 생성기 - 유기적 곡선 모양 무작위 생성",
    h1: "SVG 블롭(Blob) 생성기",
    description:
      "랜덤한 유기적 곡선 모양의 SVG 블롭을 생성합니다. 웹사이트 배경 장식, 히어로 섹션, 로고 보조 요소, 일러스트 배경에 사용. 복잡도·랜덤시드·색상 조절. SVG 코드 복사 또는 PNG 다운로드.",
    metaDescription:
      "SVG 블롭 생성기 무료. 유기적 곡선 모양, 웹 디자인 배경 장식용.",
    howTo: [
      "복잡도(꼭짓점 수)와 부드러움을 조절합니다.",
      "색상을 선택합니다.",
      "원하는 모양이 나올 때까지 'Generate'를 클릭합니다.",
      "SVG 코드를 복사하거나 PNG로 다운로드합니다.",
    ],
    faq: [
      { q: "블롭이 뭐예요?", a: "유기적인 곡선의 비정형 도형. 모던 웹 디자인의 인기 요소로, 배경 장식이나 히어로 섹션에 자주 쓰입니다." },
      { q: "어디에 쓰나요?", a: "랜딩 페이지 배경, 카드 디자인 액센트, 일러스트 배경, 프레젠테이션 슬라이드 장식." },
      { q: "SVG 코드만 받을 수 있나요?", a: "네. SVG는 코드 복사로, 비트맵 필요 시 PNG 다운로드도 지원합니다." },
      { q: "그라데이션도 가능한가요?", a: "단색·그라데이션 두 가지 모드를 지원합니다." },
      { q: "라이선스는?", a: "생성된 블롭은 사용자 소유. 상업적 사용 무제한." },
    ],
    addedAt: "2026-05-21",
  },
  {
    ...
    category: "dev",
    icon: "🔗",
    navTitle: "Data URI 생성기",
    title: "Data URI 생성기 - 파일/텍스트를 Base64 인라인 URI로",
    h1: "Data URI 생성기",
    description:
      "이미지·SVG·텍스트를 Base64 인코딩된 Data URI로 변환합니다. CSS background-image에 직접 인라인, HTML 이메일에 이미지 삽입, 외부 요청 없는 1-파일 데모, 작은 파비콘 임베드에 유용. MIME 타입 자동 감지.",
    metaDescription:
      "Data URI 무료 생성기. 이미지·SVG·텍스트 → Base64 인라인 URI.",
    howTo: [
      "파일을 업로드하거나 텍스트를 입력합니다.",
      "MIME 타입이 자동 감지됩니다.",
      "data:... 형식의 URI가 생성됩니다.",
      "복사해서 CSS background, HTML img src, 이메일에 사용합니다.",
    ],
    faq: [
      { q: "Data URI가 뭐예요?", a: "`data:image/png;base64,...` 형식으로 파일 내용을 URL 안에 직접 담는 방식. 외부 파일 요청 없이 데이터를 인라인할 수 있습니다." },
      { q: "용량 제한은?", a: "이론상 없지만 실용적으론 <10KB 권장. Base64는 원본보다 ~33% 커집니다. 큰 파일은 외부 파일이 더 효율적." },
      { q: "왜 Base64 인코딩이 필요한가요?", a: "URI 안에 안전하게 넣기 위해. 바이너리(이미지·PDF 등)는 URI 특수문자와 충돌하기 때문에 Base64로 변환합니다." },
      { q: "어디에 가장 많이 쓰이나요?", a: "(1) CSS background에 작은 아이콘, (2) 이메일 HTML에 이미지, (3) Webpack/Vite 빌드에서 작은 자산을 인라인, (4) 1-파일 HTML 데모." },
      { q: "단점은?", a: "(1) Base64로 크기 33% 증가, (2) 브라우저 캐시 못 함, (3) 큰 파일은 페이지 파싱 지연." },
    ],
    addedAt: "2026-05-21",
  },
  {
    slug: "file-hash-verify",
    component: "FileHashVerifyTool",
    category: "dev",
    icon: "🔐",
    navTitle: "파일 해시 검증",
    title: "파일 해시 검증기 - MD5/SHA-1/SHA-256 무결성 확인",
    h1: "파일 무결성 검증 (해시 비교)",
    description:
      "파일을 업로드하고 기대 해시값을 붙여넣으면 일치 여부를 자동 확인합니다. 다운로드한 파일의 무결성 확인, OS ISO·실행파일 변조 검증, Git 커밋 해시 매칭에 유용. MD5, SHA-1, SHA-256, SHA-512 지원. 브라우저 안에서 처리.",
    metaDescription:
      "파일 해시 검증 무료. MD5/SHA-1/SHA-256/SHA-512 무결성 확인, 브라우저 처리.",
    howTo: [
      "파일을 드래그하거나 업로드합니다.",
      "기대 해시값을 붙여넣습니다 (또는 비워두면 계산만 표시).",
      "일치/불일치 결과가 자동 표시됩니다.",
    ],
    faq: [
      { q: "왜 무결성 검증이 필요한가요?", a: "다운로드 중 손상되었거나 누군가 파일을 바꿔치기했는지 확인하려고. OS 설치 ISO, 보안 도구, 백업 파일에 필수입니다." },
      { q: "어떤 해시가 좋나요?", a: "SHA-256이 표준이고 가장 안전합니다. MD5/SHA-1은 보안 검증엔 부적합(충돌 가능), 단순 무결성 체크용으로만." },
      { q: "큰 파일도 가능한가요?", a: "수 GB까지 가능. 메모리에 한 번에 올리지 않고 스트림 단위로 처리합니다. 다만 브라우저 메모리 한계로 4GB+ 파일은 느릴 수 있습니다." },
      { q: "파일이 외부로 가나요?", a: "아니요. SubtleCrypto API로 브라우저 안에서 처리. 어디로도 전송되지 않습니다." },
      { q: "여러 해시를 동시에 계산?", a: "네. MD5/SHA-1/SHA-256/SHA-512를 모두 한 번에 표시합니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    slug: "file-split-join",
    component: "FileSplitJoinTool",
    category: "dev",
    icon: "✂️",
    navTitle: "파일 분할/결합",
    title: "파일 분할/결합 - 큰 파일을 작은 조각으로",
    h1: "파일 분할 / 결합기",
    description:
      "큰 파일을 일정 크기(예: 10MB) 조각으로 나누거나, 분할된 조각들을 다시 하나로 합칩니다. 이메일 첨부 한도, 카톡 파일 전송 한도, 클라우드 업로드 청크 분할에 사용. 분할 시 .part1, .part2 형식 자동 명명. 브라우저 안에서 처리.",
    metaDescription:
      "파일 분할 결합 무료. 이메일·카톡 첨부 한도 우회, 클라우드 업로드 청크.",
    howTo: [
      "분할: 파일 업로드 → 조각 크기 설정 → 'Split' → 각 파트 다운로드.",
      "결합: 모든 파트를 순서대로 업로드 → 'Join' → 원본 파일 다운로드.",
    ],
    faq: [
      { q: "어떤 형식으로 분할되나요?", a: "원본 파일이름.part1, .part2 ... 식으로 자동 명명됩니다. 결합 시 같은 순서로 업로드하면 됩니다." },
      { q: "최대 파일 크기는?", a: "이론상 무제한이지만 브라우저 메모리 한계상 4-8GB가 실용적입니다. 더 크면 분할 처리에 시간이 걸릴 수 있습니다." },
      { q: "왜 분할이 필요한가요?", a: "(1) 이메일 첨부 25MB 한도, (2) 카톡 100MB 한도, (3) 일부 클라우드의 청크 업로드, (4) 백업 매체 용량 제한." },
      { q: "분할된 파일은 일반 압축 프로그램으로도 합칠 수 있나요?", a: "이 도구는 단순 바이너리 분할입니다. 결합 시 본 도구를 쓰거나, 윈도우 명령어 `copy /b part1+part2 result.ext`로도 가능합니다." },
      { q: "분할된 파일을 직접 열 수 있나요?", a: "아니요. 분할된 조각은 부분 데이터라 단독으로 안 열립니다. 반드시 모든 조각을 합쳐야 원본이 됩니다." },
    ],
    addedAt: "2026-05-21",
  },
  {
    slug: "pdf-esign",
    component: "PdfEsignTool",
    category: "pdf",
    icon: "✍️",
    navTitle: "PDF 전자 서명",
    title: "PDF 전자 서명 - 사인 그려서 PDF에 도장",
    h1: "PDF 전자 서명 (e-sign)",
    description:
      "PDF에 직접 사인을 그리거나 이미지 도장을 업로드해 임의 위치에 합성합니다. 계약서 사인, 동의서 제출, 견적서 확인란에 자필 서명. 브라우저에서 안전 처리, 외부 업로드 없음. pdf-lib 기반.",
    metaDescription:
      "PDF 전자 서명 무료. 사인 그리기/도장 이미지 합성, 계약서·동의서용. 브라우저 처리.",
    howTo: [
      "PDF를 업로드합니다.",
      "사인을 마우스로 그리거나 도장 이미지를 업로드합니다.",
      "원하는 페이지의 위치에 드래그해 놓습니다.",
      "서명된 PDF를 다운로드합니다.",
    ],
    faq: [
      { q: "법적 효력이 있나요?", a: "한국 전자서명법상 단순 자필 서명 이미지도 양당사자가 인정하면 효력이 있습니다. 다만 중요한 계약은 공인 전자서명(공동인증서 등)을 권장합니다." },
      { q: "사인은 어떻게 그리나요?", a: "캔버스에서 마우스나 터치(태블릿)로 자연스럽게 그리면 됩니다. 잘못 그린 부분은 'Clear'로 지우고 다시 시작." },
      { q: "기존 사인 이미지를 쓸 수 있나요?", a: "네. 투명 배경 PNG로 저장한 사인 이미지를 업로드해서 도장처럼 사용할 수 있습니다." },
      { q: "파일이 외부로 가나요?", a: "아니요. pdf-lib가 브라우저 안에서 처리합니다. 계약서 같은 민감 문서도 안전합니다." },
      { q: "여러 곳에 서명할 수 있나요?", a: "네. 같은 PDF의 여러 페이지에 반복해서 도장을 찍을 수 있습니다." },
      { q: "다른 사람 이름으로 서명하면?", a: "위·변조에 해당해 법적 처벌(사문서 위조죄 등)됩니다. 본인 서명만 사용하세요." },
    ],
    addedAt: "2026-05-21",
  },
