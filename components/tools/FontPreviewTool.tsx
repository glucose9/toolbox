  ...
  return (
    <div className="card space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3 text-sm items-end">
        <label>{t("font")}<input type="text" value={font} onChange={(e) => setFont(e.target.value)} className="w-full mt-1 px-2 py-1 border border-gray-200 dark:border-gray-700 rounded bg-white dark:bg-gray-900" /></label>
