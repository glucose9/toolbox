...
export default function GolfHandicapTool() {
  const t = useTranslations("toolUI.golf-handicap");
  ...
  return (
    <div className="card space-y-3">
      <div>
        <label className="label">{t("scoresLabel")}</label>
      ...
      <div>
        <label className="label">{t("parLabel")}</label>
      ...
      {result && (
        <div className="grid grid-cols-3 gap-3">
          <div className="border border-gray-200 dark:border-gray-700 rounded p-3 text-center"><div className="text-xs text-muted">{t("rounds")}</div><div className="text-xl font-bold">{result.count}</div></div>
          <div className="border border-gray-200 dark:border-gray-700 rounded p-3 text-center"><div className="text-xs text-muted">{t("avgScore")}</div><div className="text-xl font-bold">{result.avgScore}</div></div>
          <div className="border border-brand-500 bg-brand-50 dark:bg-brand-900/20 rounded p-3 text-center"><div className="text-xs text-muted">{t("handicap")}</div><div className="text-xl font-bold">{result.handicap}</div></div>
        </div>
      )}
