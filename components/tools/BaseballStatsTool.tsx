      ...
      {mode === "era" && (
        <>
          <div className="grid grid-cols-2 gap-3">
            <div><label className="label">{t("earnedRuns")}</label><input type="number" value={er} onChange={(e) => setEr(+e.target.value)} className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded bg-white dark:bg-gray-900" /></div>
            <div><label className="label">{t("inningsPitched")}</label><input type="number" step="0.1" value={ip} onChange={(e) => setIp(+e.target.value)} className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded bg-white dark:bg-gray-900" /></div>
          </div>
