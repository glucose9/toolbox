...
const KoreanCiteTool = dynamic(() => import("./tools/KoreanCiteTool"), { ssr: false });
const TextNormalizeTool = dynamic(() => import("./tools/TextNormalizeTool"), { ssr: false });
const FootnoteFormatTool = dynamic(() => import("./tools/FootnoteFormatTool"), { ssr: false });
const LoanCalcTool = dynamic(() => import("./tools/LoanCalcTool"), { ssr: false });
const SavingsCalcTool = dynamic(() => import("./tools/SavingsCalcTool"), { ssr: false });
const NetSalaryTool = dynamic(() => import("./tools/NetSalaryTool"), { ssr: false });
...
const DocxToPdfTool = dynamic(() => import("./tools/DocxToPdfTool"), { ssr: false });
const XlsxToPdfTool = dynamic(() => import("./tools/XlsxToPdfTool"), { ssr: false });
const PptxToPdfTool = dynamic(() => import("./tools/PptxToPdfTool"), { ssr: false });
const HtmlToPdfTool = dynamic(() => import("./tools/HtmlToPdfTool"), { ssr: false });
const MdToPdfTool = dynamic(() => import("./tools/MdToPdfTool"), { ssr: false });
const TxtToPdfTool = dynamic(() => import("./tools/TxtToPdfTool"), { ssr: false });
const PdfToDocxTool = dynamic(() => import("./tools/PdfToDocxTool"), { ssr: false });
const PdfToXlsxTool = dynamic(() => import("./tools/PdfToXlsxTool"), { ssr: false });
const PdfToPptxTool = dynamic(() => import("./tools/PdfToPptxTool"), { ssr: false });
const PdfToHtmlTool = dynamic(() => import("./tools/PdfToHtmlTool"), { ssr: false });
const PdfToMdTool = dynamic(() => import("./tools/PdfToMdTool"), { ssr: false });
